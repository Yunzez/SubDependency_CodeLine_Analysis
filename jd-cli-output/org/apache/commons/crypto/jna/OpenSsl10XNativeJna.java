...
class OpenSsl10XNativeJna {
  ...
  public static native String SSLeay_version(int paramInt);
  ...
  public static native void EVP_CIPHER_CTX_init(PointerByReference paramPointerByReference);
  ...
  public static native void EVP_CIPHER_CTX_cleanup(PointerByReference paramPointerByReference);
