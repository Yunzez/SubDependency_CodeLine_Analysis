...
public class BCLMSPrivateKey implements PrivateKey, LMSPrivateKey {
  ...
  public LMSPrivateKey extractKeyShard(int paramInt) {
    return (this.keyParams instanceof LMSPrivateKeyParameters) ? new BCLMSPrivateKey(((LMSPrivateKeyParameters)this.keyParams).extractKeyShard(paramInt)) : new BCLMSPrivateKey(((HSSPrivateKeyParameters)this.keyParams).extractKeyShard(paramInt));
  }
