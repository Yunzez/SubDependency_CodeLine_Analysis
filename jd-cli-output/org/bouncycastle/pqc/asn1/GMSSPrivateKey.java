  ...
  private ASN1Primitive encode(int[] paramArrayOfint1, byte[][] paramArrayOfbyte1, byte[][] paramArrayOfbyte2, byte[][][] paramArrayOfbyte3, byte[][][] paramArrayOfbyte4, byte[][][] paramArrayOfbyte5, Treehash[][] paramArrayOfTreehash1, Treehash[][] paramArrayOfTreehash2, Vector[] paramArrayOfVector1, Vector[] paramArrayOfVector2, Vector[][] paramArrayOfVector3, Vector[][] paramArrayOfVector4, GMSSLeaf[] paramArrayOfGMSSLeaf1, GMSSLeaf[] paramArrayOfGMSSLeaf2, GMSSLeaf[] paramArrayOfGMSSLeaf3, int[] paramArrayOfint2, byte[][] paramArrayOfbyte6, GMSSRootCalc[] paramArrayOfGMSSRootCalc, byte[][] paramArrayOfbyte7, GMSSRootSig[] paramArrayOfGMSSRootSig, GMSSParameters paramGMSSParameters, AlgorithmIdentifier[] paramArrayOfAlgorithmIdentifier) {
    ...
    for (byte b8 = 0; b8 < paramArrayOfVector1.length; b8++) {
      for (byte b = 0; b < paramArrayOfVector1[b8].size(); b++)
        aSN1EncodableVector16.add(new DEROctetString(paramArrayOfVector1[b8].elementAt(b))); 
    ...
    for (byte b9 = 0; b9 < paramArrayOfVector2.length; b9++) {
      for (byte b = 0; b < paramArrayOfVector2[b9].size(); b++)
        aSN1EncodableVector18.add(new DEROctetString(paramArrayOfVector2[b9].elementAt(b))); 
    ...
    for (byte b10 = 0; b10 < paramArrayOfVector3.length; b10++) {
      for (byte b = 0; b < (paramArrayOfVector3[b10]).length; b++) {
        for (byte b22 = 0; b22 < paramArrayOfVector3[b10][b].size(); b22++)
          aSN1EncodableVector20.add(new DEROctetString(paramArrayOfVector3[b10][b].elementAt(b22))); 
    ...
    for (byte b11 = 0; b11 < paramArrayOfVector4.length; b11++) {
      for (byte b = 0; b < (paramArrayOfVector4[b11]).length; b++) {
        for (byte b22 = 0; b22 < paramArrayOfVector4[b11][b].size(); b22++)
          aSN1EncodableVector23.add(new DEROctetString(paramArrayOfVector4[b11][b].elementAt(b22))); 
    ...
    for (byte b17 = 0; b17 < paramArrayOfGMSSRootCalc.length; b17++) {
      ...
      byte b;
      for (b = 0; b < i; b++)
        aSN1EncodableVector34.add(new DEROctetString(paramArrayOfGMSSRootCalc[b17].getStatByte()[1 + b])); 
      for (b = 0; b < j; b++)
        aSN1EncodableVector34.add(new DEROctetString(paramArrayOfGMSSRootCalc[b17].getStatByte()[1 + i + b])); 
      ...
      for (b = 0; b < i; b++)
        aSN1EncodableVector35.add(new ASN1Integer(paramArrayOfGMSSRootCalc[b17].getStatInt()[8 + b])); 
      for (b = 0; b < j; b++)
        aSN1EncodableVector35.add(new ASN1Integer(paramArrayOfGMSSRootCalc[b17].getStatInt()[8 + i + b])); 
      ...
      if (paramArrayOfGMSSRootCalc[b17].getTreehash() != null)
        for (b = 0; b < (paramArrayOfGMSSRootCalc[b17].getTreehash()).length; b++) {
          ...
          aSN1EncodableVector12.add(new DEROctetString(paramArrayOfGMSSRootCalc[b17].getTreehash()[b].getStatByte()[0]));
          aSN1EncodableVector12.add(new DEROctetString(paramArrayOfGMSSRootCalc[b17].getTreehash()[b].getStatByte()[1]));
          aSN1EncodableVector12.add(new DEROctetString(paramArrayOfGMSSRootCalc[b17].getTreehash()[b].getStatByte()[2]));
          byte b22;
          for (b22 = 0; b22 < j; b22++)
            aSN1EncodableVector12.add(new DEROctetString(paramArrayOfGMSSRootCalc[b17].getTreehash()[b].getStatByte()[3 + b22])); 
          aSN1EncodableVector11.add(new DERSequence(aSN1EncodableVector12));
          aSN1EncodableVector12 = new ASN1EncodableVector();
          aSN1EncodableVector13.add(new ASN1Integer(paramArrayOfGMSSRootCalc[b17].getTreehash()[b].getStatInt()[0]));
          aSN1EncodableVector13.add(new ASN1Integer(j));
          aSN1EncodableVector13.add(new ASN1Integer(paramArrayOfGMSSRootCalc[b17].getTreehash()[b].getStatInt()[2]));
          aSN1EncodableVector13.add(new ASN1Integer(paramArrayOfGMSSRootCalc[b17].getTreehash()[b].getStatInt()[3]));
          aSN1EncodableVector13.add(new ASN1Integer(paramArrayOfGMSSRootCalc[b17].getTreehash()[b].getStatInt()[4]));
          aSN1EncodableVector13.add(new ASN1Integer(paramArrayOfGMSSRootCalc[b17].getTreehash()[b].getStatInt()[5]));
          for (b22 = 0; b22 < j; b22++)
            aSN1EncodableVector13.add(new ASN1Integer(paramArrayOfGMSSRootCalc[b17].getTreehash()[b].getStatInt()[6 + b22])); 
          aSN1EncodableVector11.add(new DERSequence(aSN1EncodableVector13));
          aSN1EncodableVector13 = new ASN1EncodableVector();
      ...
      if (paramArrayOfGMSSRootCalc[b17].getRetain() != null)
        for (b = 0; b < (paramArrayOfGMSSRootCalc[b17].getRetain()).length; b++) {
          for (byte b22 = 0; b22 < paramArrayOfGMSSRootCalc[b17].getRetain()[b].size(); b22++)
            aSN1EncodableVector20.add(new DEROctetString(paramArrayOfGMSSRootCalc[b17].getRetain()[b].elementAt(b22))); 
