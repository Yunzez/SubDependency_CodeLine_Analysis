  ...
  private static ASN1Sequence fromCertificate(X509Certificate paramX509Certificate) throws CertificateParsingException {
    try {
      if (paramX509Certificate.getVersion() != 3) {
        GeneralName generalName1 = new GeneralName(PrincipalUtil.getIssuerX509Principal(paramX509Certificate));
      ...
      GeneralName generalName = new GeneralName(PrincipalUtil.getIssuerX509Principal(paramX509Certificate));
