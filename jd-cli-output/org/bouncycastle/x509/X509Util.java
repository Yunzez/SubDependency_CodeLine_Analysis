...
class X509Util {
  ...
  static AlgorithmIdentifier getSigAlgID(ASN1ObjectIdentifier paramASN1ObjectIdentifier, String paramString) {
    ...
    paramString = Strings.toUpperCase(paramString);
    return params.containsKey(paramString) ? new AlgorithmIdentifier(paramASN1ObjectIdentifier, (ASN1Encodable)params.get(paramString)) : new AlgorithmIdentifier(paramASN1ObjectIdentifier, DERNull.INSTANCE);
  }
  ...
  static {
    ...
    AlgorithmIdentifier algorithmIdentifier1 = new AlgorithmIdentifier(OIWObjectIdentifiers.idSHA1, DERNull.INSTANCE);
