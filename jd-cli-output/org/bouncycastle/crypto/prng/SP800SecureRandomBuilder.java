...
public class SP800SecureRandomBuilder {
  ...
  private static class CTRDRBGProvider implements DRBGProvider {
    ...
    public SP80090DRBG get(EntropySource param1EntropySource) {
      return new CTRSP800DRBG(this.blockCipher, this.keySizeInBits, this.securityStrength, param1EntropySource, this.personalizationString, this.nonce);
    }
  }
  ...
  private static class HMacDRBGProvider implements DRBGProvider {
    ...
    public SP80090DRBG get(EntropySource param1EntropySource) {
      return new HMacSP800DRBG(this.hMac, this.securityStrength, param1EntropySource, this.personalizationString, this.nonce);
    }
  }
  ...
  private static class HashDRBGProvider implements DRBGProvider {
    ...
    public SP80090DRBG get(EntropySource param1EntropySource) {
      return new HashSP800DRBG(this.digest, this.securityStrength, param1EntropySource, this.personalizationString, this.nonce);
    }
  }
}
