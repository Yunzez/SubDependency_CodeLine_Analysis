...
public class DHKEKGenerator implements DerivationFunction {
  ...
  public int generateBytes(byte[] paramArrayOfbyte, int paramInt1, int paramInt2) throws DataLengthException, IllegalArgumentException {
    ...
    for (byte b2 = 0; b2 < j; b2++) {
      ...
      aSN1EncodableVector2.add(new DEROctetString(Pack.intToBigEndian(b1)));
      aSN1EncodableVector1.add(new DERSequence(aSN1EncodableVector2));
      if (this.partyAInfo != null)
        aSN1EncodableVector1.add(new DERTaggedObject(true, 0, new DEROctetString(this.partyAInfo))); 
      aSN1EncodableVector1.add(new DERTaggedObject(true, 2, new DEROctetString(Pack.intToBigEndian(this.keySize))));
      try {
