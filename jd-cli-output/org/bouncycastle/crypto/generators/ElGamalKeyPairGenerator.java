...
public class ElGamalKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
  ...
  public AsymmetricCipherKeyPair generateKeyPair() {
    ...
    return new AsymmetricCipherKeyPair(new ElGamalPublicKeyParameters(bigInteger2, elGamalParameters), new ElGamalPrivateKeyParameters(bigInteger1, elGamalParameters));
  }
}
