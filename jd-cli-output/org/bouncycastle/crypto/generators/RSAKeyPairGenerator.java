...
public class RSAKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
  ...
  public AsymmetricCipherKeyPair generateKeyPair() {
    ...
    while (!bool) {
      ...
      asymmetricCipherKeyPair = new AsymmetricCipherKeyPair(new RSAKeyParameters(false, bigInteger6, bigInteger8), new RSAPrivateCrtKeyParameters(bigInteger6, bigInteger8, bigInteger7, bigInteger4, bigInteger5, bigInteger11, bigInteger12, bigInteger13));
    } 
