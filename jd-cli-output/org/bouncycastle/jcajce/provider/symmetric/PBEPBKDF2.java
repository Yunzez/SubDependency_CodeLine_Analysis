    ...
    protected SecretKey engineGenerateSecret(KeySpec param1KeySpec) throws InvalidKeySpecException {
      if (param1KeySpec instanceof PBEKeySpec) {
        ...
        if (pBEKeySpec.getSalt() == null)
          return new PBKDF2Key(((PBEKeySpec)param1KeySpec).getPassword(), (this.scheme == 1) ? PasswordConverter.ASCII : PasswordConverter.UTF8); 
        ...
        if (pBEKeySpec instanceof PBKDF2KeySpec) {
          ...
          return new BCPBEKey(this.algName, this.algOid, this.scheme, k, m, b1, pBEKeySpec, cipherParameters1);
        } 
        ...
        return new BCPBEKey(this.algName, this.algOid, this.scheme, i, j, b, pBEKeySpec, cipherParameters);
      } 
