    ...
    protected SecretKey engineGenerateSecret(KeySpec param1KeySpec) throws InvalidKeySpecException {
      if (param1KeySpec instanceof PBEKeySpec) {
        ...
        if (pBEKeySpec.getSalt() == null)
          return (SecretKey)((this.scheme == 0 || this.scheme == 4) ? new PBKDF1Key(pBEKeySpec.getPassword(), (this.scheme == 0) ? PasswordConverter.ASCII : PasswordConverter.UTF8) : new BCPBEKey(this.algName, this.algOid, this.scheme, this.digest, this.keySize, this.ivSize, pBEKeySpec, null)); 
        if (this.forCipher) {
