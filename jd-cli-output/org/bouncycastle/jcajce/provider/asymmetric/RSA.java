...
public class RSA {
  ...
  public static class Mappings extends AsymmetricAlgorithmProvider {
    public void configure(ConfigurableProvider param1ConfigurableProvider) {
      ...
      registerOid(param1ConfigurableProvider, PKCSObjectIdentifiers.rsaEncryption, "RSA", keyFactorySpi);
      registerOid(param1ConfigurableProvider, X509ObjectIdentifiers.id_ea_rsa, "RSA", keyFactorySpi);
      registerOid(param1ConfigurableProvider, PKCSObjectIdentifiers.id_RSAES_OAEP, "RSA", keyFactorySpi);
      registerOid(param1ConfigurableProvider, PKCSObjectIdentifiers.id_RSASSA_PSS, "RSA", keyFactorySpi);
