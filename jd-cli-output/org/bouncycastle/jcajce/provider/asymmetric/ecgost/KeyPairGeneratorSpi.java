...
public class KeyPairGeneratorSpi extends KeyPairGenerator {
  ...
  private void init(GOST3410ParameterSpec paramGOST3410ParameterSpec, SecureRandom paramSecureRandom) throws InvalidAlgorithmParameterException {
    ...
    this.param = new ECKeyGenerationParameters(new ECGOST3410Parameters(new ECNamedDomainParameters(aSN1ObjectIdentifier, x9ECParameters), aSN1ObjectIdentifier, paramGOST3410ParameterSpec.getDigestParamSet(), paramGOST3410ParameterSpec.getEncryptionParamSet()), paramSecureRandom);
    this.engine.init(this.param);
    this.initialised = true;
  }
