...
public class KeyAgreementSpi extends BaseAgreementSpi {
  ...
  static AsymmetricKeyParameter generatePublicKeyParameter(PublicKey paramPublicKey) throws InvalidKeyException {
    return (paramPublicKey instanceof org.bouncycastle.jcajce.provider.asymmetric.ec.BCECPublicKey) ? ((BCECGOST3410PublicKey)paramPublicKey).engineGetKeyParameters() : ECUtil.generatePublicKeyParameter(paramPublicKey);
  }
