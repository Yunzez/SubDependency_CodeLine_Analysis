...
public class DSTU4145 {
  ...
  public static class Mappings extends AsymmetricAlgorithmProvider {
    public void configure(ConfigurableProvider param1ConfigurableProvider) {
      ...
      registerOid(param1ConfigurableProvider, UAObjectIdentifiers.dstu4145le, "DSTU4145", new KeyFactorySpi());
      registerOidAlgorithmParameters(param1ConfigurableProvider, UAObjectIdentifiers.dstu4145le, "DSTU4145");
      registerOid(param1ConfigurableProvider, UAObjectIdentifiers.dstu4145be, "DSTU4145", new KeyFactorySpi());
