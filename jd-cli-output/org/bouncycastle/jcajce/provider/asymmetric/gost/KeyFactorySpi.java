...
public class KeyFactorySpi extends BaseKeyFactorySpi {
  ...
  protected PrivateKey engineGeneratePrivate(KeySpec paramKeySpec) throws InvalidKeySpecException {
    return (paramKeySpec instanceof GOST3410PrivateKeySpec) ? new BCGOST3410PrivateKey((GOST3410PrivateKeySpec)paramKeySpec) : super.engineGeneratePrivate(paramKeySpec);
  }
  
  protected PublicKey engineGeneratePublic(KeySpec paramKeySpec) throws InvalidKeySpecException {
    return (paramKeySpec instanceof GOST3410PublicKeySpec) ? new BCGOST3410PublicKey((GOST3410PublicKeySpec)paramKeySpec) : super.engineGeneratePublic(paramKeySpec);
  }
