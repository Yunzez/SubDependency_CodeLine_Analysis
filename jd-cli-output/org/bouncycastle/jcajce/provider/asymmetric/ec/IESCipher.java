...
public class IESCipher extends CipherSpi {
  ...
  public byte[] engineDoFinal(byte[] paramArrayOfbyte, int paramInt1, int paramInt2) throws IllegalBlockSizeException, BadPaddingException {
    ...
    if (this.state == 2 || this.state == 4)
      try {
        this.engine.init(this.key, parametersWithIV, new ECIESPublicKeyParser(eCDomainParameters));
        return this.engine.processBlock(arrayOfByte, 0, arrayOfByte.length);
  ...
  public static class ECIES extends IESCipher {
    ...
    public ECIES(Digest param1Digest1, Digest param1Digest2) {
      super(new IESEngine(new ECDHBasicAgreement(), new KDF2BytesGenerator(param1Digest1), new HMac(param1Digest2)));
    }
  }
  ...
  public static class ECIESwithCipher extends IESCipher {
    ...
    public ECIESwithCipher(BlockCipher param1BlockCipher, int param1Int, Digest param1Digest1, Digest param1Digest2) {
      super(new IESEngine(new ECDHBasicAgreement(), new KDF2BytesGenerator(param1Digest1), new HMac(param1Digest2), new PaddedBufferedBlockCipher(param1BlockCipher)), param1Int);
    }
  }
