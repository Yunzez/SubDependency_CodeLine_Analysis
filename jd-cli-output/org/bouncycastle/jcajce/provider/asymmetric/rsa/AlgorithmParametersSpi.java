...
public abstract class AlgorithmParametersSpi extends AlgorithmParametersSpi {
  ...
  public static class OAEP extends AlgorithmParametersSpi {
    ...
    protected byte[] engineGetEncoded() {
      AlgorithmIdentifier algorithmIdentifier1 = new AlgorithmIdentifier(DigestFactory.getOID(this.currentSpec.getDigestAlgorithm()), DERNull.INSTANCE);
  ...
  public static class PSS extends AlgorithmParametersSpi {
    ...
    protected byte[] engineGetEncoded() throws IOException {
      ...
      AlgorithmIdentifier algorithmIdentifier1 = new AlgorithmIdentifier(DigestFactory.getOID(pSSParameterSpec.getDigestAlgorithm()), DERNull.INSTANCE);
      MGF1ParameterSpec mGF1ParameterSpec = (MGF1ParameterSpec)pSSParameterSpec.getMGFParameters();
      if (mGF1ParameterSpec != null) {
        AlgorithmIdentifier algorithmIdentifier = new AlgorithmIdentifier(PKCSObjectIdentifiers.id_mgf1, new AlgorithmIdentifier(DigestFactory.getOID(mGF1ParameterSpec.getDigestAlgorithm()), DERNull.INSTANCE));
    ...
    protected void engineInit(byte[] param1ArrayOfbyte) throws IOException {
      try {
        ...
        if (aSN1ObjectIdentifier.equals(PKCSObjectIdentifiers.id_mgf1)) {
        ...
        } else if (aSN1ObjectIdentifier.equals(NISTObjectIdentifiers.id_shake128) || aSN1ObjectIdentifier.equals(NISTObjectIdentifiers.id_shake256)) {
          this.currentSpec = new PSSParameterSpec(MessageDigestUtils.getDigestName(rSASSAPSSparams.getHashAlgorithm().getAlgorithm()), aSN1ObjectIdentifier.equals(NISTObjectIdentifiers.id_shake128) ? "SHAKE128" : "SHAKE256", null, rSASSAPSSparams.getSaltLength().intValue(), rSASSAPSSparams.getTrailerField().intValue());
        } else {
