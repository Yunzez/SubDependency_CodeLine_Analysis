...
public class CipherSpi extends BaseCipherSpi {
  ...
  private void initFromSpec(OAEPParameterSpec paramOAEPParameterSpec) throws NoSuchPaddingException {
    ...
    this.cipher = new OAEPEncoding(new RSABlindedEngine(), digest, ((PSource.PSpecified)paramOAEPParameterSpec.getPSource()).getValue());
  ...
  protected void engineInit(int paramInt, Key paramKey, AlgorithmParameterSpec paramAlgorithmParameterSpec, SecureRandom paramSecureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
    ...
    if (paramAlgorithmParameterSpec == null || paramAlgorithmParameterSpec instanceof OAEPParameterSpec) {
      ...
      if (paramAlgorithmParameterSpec != null) {
        ...
        this.cipher = new OAEPEncoding(new RSABlindedEngine(), digest1, digest2, ((PSource.PSpecified)oAEPParameterSpec.getPSource()).getValue());
      } 
    } else {
    ...
    if (!(this.cipher instanceof RSABlindedEngine))
      if (paramSecureRandom != null) {
        parametersWithRandom = new ParametersWithRandom(rSAKeyParameters, paramSecureRandom);
      } else {
        parametersWithRandom = new ParametersWithRandom(parametersWithRandom, CryptoServicesRegistrar.getSecureRandom());
      }  
    this.bOut.reset();
    switch (paramInt) {
      case 1:
