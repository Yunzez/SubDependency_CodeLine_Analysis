...
public class JCEECPublicKey implements ECPublicKey, ECPublicKey, ECPointEncoder {
  ...
  public byte[] getEncoded() {
    ...
    if (this.algorithm.equals("ECGOST3410")) {
      ...
      try {
        subjectPublicKeyInfo = new SubjectPublicKeyInfo(new AlgorithmIdentifier(CryptoProObjectIdentifiers.gostR3410_2001, x962Parameters), new DEROctetString(arrayOfByte));
      } catch (IOException iOException) {
        return null;
      } 
    } else {
      ...
      subjectPublicKeyInfo = new SubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_ecPublicKey, x962Parameters), arrayOfByte);
    } 
