...
public class Curve25519Point extends ECPoint.AbstractFp {
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    return new Curve25519Point(eCCurve, curve25519FieldElement7, curve25519FieldElement8, arrayOfECFieldElement);
  }
  ...
  public ECPoint twice() {
    ...
    return eCFieldElement.isZero() ? eCCurve.getInfinity() : twiceJacobianModified(true);
  }
  ...
  public ECPoint threeTimes() {
    if (isInfinity())
      return this; 
    ECFieldElement eCFieldElement = this.y;
    return eCFieldElement.isZero() ? this : twiceJacobianModified(false).add(this);
  }
  ...
  protected Curve25519Point twiceJacobianModified(boolean paramBoolean) {
    ...
    return new Curve25519Point(getCurve(), curve25519FieldElement5, curve25519FieldElement6, new ECFieldElement[] { curve25519FieldElement7, curve25519FieldElement8 });
  }
}
