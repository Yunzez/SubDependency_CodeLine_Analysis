...
public class SecT571K1Point extends ECPoint.AbstractF2m {
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    if (secT571FieldElement2.isZero()) {
      ...
      if (secT571FieldElement7.isZero())
        return new SecT571K1Point(eCCurve, secT571FieldElement7, eCCurve.getB()); 
    ...
    return new SecT571K1Point(eCCurve, secT571FieldElement7, secT571FieldElement8, new ECFieldElement[] { secT571FieldElement9 });
  }
  ...
  public ECPoint negate() {
    ...
    ECFieldElement eCFieldElement2 = this.y;
    ECFieldElement eCFieldElement3 = this.zs[0];
    return new SecT571K1Point(this.curve, eCFieldElement1, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[] { eCFieldElement3 });
  }
}
