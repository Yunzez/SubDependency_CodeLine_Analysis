...
public class SecT283R1Point extends ECPoint.AbstractF2m {
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    if (eCFieldElement2.isZero()) {
      ...
      if (eCFieldElement13.isZero())
        return new SecT283R1Point(eCCurve, eCFieldElement13, eCCurve.getB().sqrt()); 
    ...
    return new SecT283R1Point(eCCurve, eCFieldElement13, eCFieldElement14, new ECFieldElement[] { eCFieldElement15 });
  }
  ...
  public ECPoint negate() {
    ...
    ECFieldElement eCFieldElement2 = this.y;
    ECFieldElement eCFieldElement3 = this.zs[0];
    return new SecT283R1Point(this.curve, eCFieldElement1, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[] { eCFieldElement3 });
  }
}
