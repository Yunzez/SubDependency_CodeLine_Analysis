...
public class SecT409R1Point extends ECPoint.AbstractF2m {
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    if (eCFieldElement1.isZero())
      return eCFieldElement2.isZero() ? eCCurve.getInfinity() : paramECPoint.add(this); 
    ...
    if (eCFieldElement2.isZero()) {
      ...
      if (eCFieldElement13.isZero())
        return new SecT409R1Point(eCCurve, eCFieldElement13, eCCurve.getB().sqrt()); 
    ...
    return new SecT409R1Point(eCCurve, eCFieldElement13, eCFieldElement14, new ECFieldElement[] { eCFieldElement15 });
  }
  ...
  public ECPoint twice() {
    ...
    if (eCFieldElement6.isZero())
      return new SecT409R1Point(eCCurve, eCFieldElement6, eCCurve.getB().sqrt()); 
    ...
    return new SecT409R1Point(eCCurve, eCFieldElement7, eCFieldElement10, new ECFieldElement[] { eCFieldElement8 });
  }
  ...
  public ECPoint twicePlus(ECPoint paramECPoint) {
    ...
    if (eCFieldElement12.isZero())
      return new SecT409R1Point(eCCurve, eCFieldElement12, eCCurve.getB().sqrt()); 
    ...
    return new SecT409R1Point(eCCurve, eCFieldElement15, eCFieldElement17, new ECFieldElement[] { eCFieldElement16 });
  }
  ...
  public ECPoint negate() {
    ...
    ECFieldElement eCFieldElement2 = this.y;
    ECFieldElement eCFieldElement3 = this.zs[0];
    return new SecT409R1Point(this.curve, eCFieldElement1, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[] { eCFieldElement3 });
  }
}
