...
public class SecT571R1Point extends ECPoint.AbstractF2m {
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    if (secT571FieldElement1.isZero())
      return secT571FieldElement2.isZero() ? eCCurve.getInfinity() : paramECPoint.add(this); 
    ...
    if (secT571FieldElement2.isZero()) {
      ...
      if (secT571FieldElement7.isZero())
        return new SecT571R1Point(eCCurve, secT571FieldElement7, SecT571R1Curve.SecT571R1_B_SQRT); 
    ...
    return new SecT571R1Point(eCCurve, secT571FieldElement7, secT571FieldElement8, new ECFieldElement[] { secT571FieldElement9 });
  }
  ...
  public ECPoint twice() {
    ...
    if (Nat576.isZero64(arrayOfLong6))
      return new SecT571R1Point(eCCurve, new SecT571FieldElement(arrayOfLong6), SecT571R1Curve.SecT571R1_B_SQRT); 
  ...
  public ECPoint twicePlus(ECPoint paramECPoint) {
    ...
    if (Nat576.isZero64(arrayOfLong11))
      return new SecT571R1Point(eCCurve, new SecT571FieldElement(arrayOfLong11), SecT571R1Curve.SecT571R1_B_SQRT); 
  ...
  public ECPoint negate() {
    ...
    return new SecT571R1Point(this.curve, eCFieldElement1, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[] { eCFieldElement3 });
  }
}
