  ...
  public ASN1Primitive toASN1Primitive() {
    if (this.seq == null) {
      ...
      for (byte b = 0; b != this.ordering.size(); b++) {
        ...
        aSN1EncodableVector.add(aSN1ObjectIdentifier1);
        String str = this.values.elementAt(b);
        aSN1EncodableVector.add(this.converter.getConvertedValue(aSN1ObjectIdentifier1, str));
      ...
      aSN1EncodableVector1.add(new DERSet(aSN1EncodableVector2));
      this.seq = new DERSequence(aSN1EncodableVector1);
    } 
    return this.seq;
  }
