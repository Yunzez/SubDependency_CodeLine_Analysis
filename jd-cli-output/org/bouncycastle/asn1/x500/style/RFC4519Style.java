...
public class RFC4519Style extends AbstractX500NameStyle {
  ...
  protected ASN1Encodable encodeStringValue(ASN1ObjectIdentifier paramASN1ObjectIdentifier, String paramString) {
    return paramASN1ObjectIdentifier.equals(dc) ? new DERIA5String(paramString) : ((paramASN1ObjectIdentifier.equals(c) || paramASN1ObjectIdentifier.equals(serialNumber) || paramASN1ObjectIdentifier.equals(dnQualifier) || paramASN1ObjectIdentifier.equals(telephoneNumber)) ? new DERPrintableString(paramString) : super.encodeStringValue(paramASN1ObjectIdentifier, paramString));
  }
