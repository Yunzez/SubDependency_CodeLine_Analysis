...
public class ASN1RelativeOID extends ASN1Primitive {
  ...
  ASN1RelativeOID(ASN1RelativeOID paramASN1RelativeOID, String paramString) {
    if (!isValidIdentifier(paramString, 0))
      throw new IllegalArgumentException("string " + paramString + " not a valid OID branch"); 
    this.identifier = paramASN1RelativeOID.getId() + "." + paramString;
  }
  ...
  public ASN1RelativeOID branch(String paramString) {
    return new ASN1RelativeOID(this, paramString);
  }
  ...
  static ASN1RelativeOID createPrimitive(byte[] paramArrayOfbyte, boolean paramBoolean) {
    return new ASN1RelativeOID(paramArrayOfbyte, paramBoolean);
  }
