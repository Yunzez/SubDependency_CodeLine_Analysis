    ...
    if (!isInitialized()) {
      if (this.stringDigesterConfig != null) {
        ...
        this
          ...
          .unicodeNormalizationIgnored = (this.unicodeNormalizationIgnoredSet || configUnicodeNormalizationIgnored == null) ? this.unicodeNormalizationIgnored : configUnicodeNormalizationIgnored.booleanValue();
