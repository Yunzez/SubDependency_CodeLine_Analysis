    ...
    if (!this.initialized) {
      if (this.config != null) {
        ...
        this
          ...
          .saltSizeBytes = (this.saltSizeBytesSet || configSaltSizeBytes == null) ? this.saltSizeBytes : configSaltSizeBytes.intValue();
        this
          
          .iterations = (this.iterationsSet || configIterations == null) ? this.iterations : configIterations.intValue();
        ...
        this
          ...
          .invertPositionOfSaltInMessageBeforeDigesting = (this.invertPositionOfSaltInMessageBeforeDigestingSet || configInvertPositionOfSaltInMessageBeforeDigesting == null) ? this.invertPositionOfSaltInMessageBeforeDigesting : configInvertPositionOfSaltInMessageBeforeDigesting.booleanValue();
        this
          
          .invertPositionOfPlainSaltInEncryptionResults = (this.invertPositionOfPlainSaltInEncryptionResultsSet || configInvertPositionOfPlainSaltInEncryptionResults == null) ? this.invertPositionOfPlainSaltInEncryptionResults : configInvertPositionOfPlainSaltInEncryptionResults.booleanValue();
        this
          
          .useLenientSaltSizeCheck = (this.useLenientSaltSizeCheckSet || configUseLenientSaltSizeCheck == null) ? this.useLenientSaltSizeCheck : configUseLenientSaltSizeCheck.booleanValue();
      } 
      if (this.saltGenerator == null)
        this.saltGenerator = new RandomSaltGenerator(); 
      if (this.useLenientSaltSizeCheck && 
        !this.saltGenerator.includePlainSaltInEncryptionResults())
        throw new EncryptionInitializationException("The configured Salt Generator (" + this.saltGenerator
            
            .getClass().getName() + ") does not include plain salt in encryption results, which is not compatiblewith setting the salt size checking behaviour to \"lenient\"."); 
      try {
        if (this.provider != null) {
          this
            .md = MessageDigest.getInstance(this.algorithm, this.provider);
        } else if (this.providerName != null) {
          this
            .md = MessageDigest.getInstance(this.algorithm, this.providerName);
        } else {
