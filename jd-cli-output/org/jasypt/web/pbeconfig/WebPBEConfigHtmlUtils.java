...
final class WebPBEConfigHtmlUtils {
  ...
  public static String createInputFormHtml(HttpServletRequest request, boolean inputError) {
    ...
    while (configsIter.hasNext()) {
      ...
      strBuff.append("      <label for=\"jasyptVa" + i + "\">Validation word</label>: <input type=\"password\" name=\"" + "jasyptVa" + i + "\" />\n");
      strBuff.append("      <br /><br />\n");
      strBuff.append("      <label for=\"jasyptPw" + i + "\">Password</label>: <input type=\"password\" name=\"" + "jasyptPw" + i + "\" />\n");
      strBuff.append("      <br /><br />\n");
      strBuff.append("      <label for=\"jasyptRPw" + i + "\">Retype password</label>: <input type=\"password\" name=\"" + "jasyptRPw" + i + "\" />\n");
      strBuff.append("     </fieldset>\n");
      i++;
    } 
    strBuff.append("    </div>\n");
