...
public final class JasyptStringDigestCLI {
  ...
  private static final String[][] VALID_OPTIONAL_ARGUMENTS = new String[][] { 
      { "verbose" }, { "algorithm" }, { "iterations" }, { "saltSizeBytes" }, { "saltGeneratorClassName" }, { "providerName" }, { "providerClassName" }, { "invertPositionOfSaltInMessageBeforeDigesting" }, { "invertPositionOfPlainSaltInEncryptionResults" }, { "useLenientSaltSizeCheck" }, 
      { "unicodeNormalizationIgnored" }, { "stringOutputType" }, { "prefix" }, { "suffix" } };
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      String result = service.digest(input, argumentValues
          
          .getProperty("algorithm"), null, null, argumentValues

          
          .getProperty("iterations"), null, null, argumentValues

          
          .getProperty("saltSizeBytes"), null, null, argumentValues
          ...
          .getProperty("invertPositionOfSaltInMessageBeforeDigesting"), null, null, argumentValues

          
          .getProperty("invertPositionOfPlainSaltInEncryptionResults"), null, null, argumentValues

          
          .getProperty("useLenientSaltSizeCheck"), null, null, argumentValues

          
          .getProperty("unicodeNormalizationIgnored"), null, null, argumentValues

          
          .getProperty("stringOutputType"), null, null, argumentValues

          
          .getProperty("prefix"), null, null, argumentValues

          
          .getProperty("suffix"), null, null);
