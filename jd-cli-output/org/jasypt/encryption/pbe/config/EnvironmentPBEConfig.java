...
public class EnvironmentPBEConfig extends SimplePBEConfig {
  ...
  public void setIvGeneratorClassNameEnvName(String ivGeneratorClassNameEnvName) {
    ...
    if (ivGeneratorClassNameEnvName == null) {
      ...
      String ivGeneratorClassName = System.getenv(ivGeneratorClassNameEnvName);
  ...
  public void setIvGeneratorClassNameSysPropertyName(String ivGeneratorClassNameSysPropertyName) {
    ...
    if (ivGeneratorClassNameSysPropertyName == null) {
      ...
      String ivGeneratorClassName = System.getProperty(ivGeneratorClassNameSysPropertyName);
      super.setIvGeneratorClassName(ivGeneratorClassName);
    } 
  }
