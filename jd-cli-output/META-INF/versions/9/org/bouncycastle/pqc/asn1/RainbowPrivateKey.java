...
public class RainbowPrivateKey extends ASN1Object {
  ...
  public static org.bouncycastle.pqc.asn1.RainbowPrivateKey getInstance(Object paramObject) {
    if (paramObject instanceof org.bouncycastle.pqc.asn1.RainbowPrivateKey)
      return (org.bouncycastle.pqc.asn1.RainbowPrivateKey)paramObject; 
    if (paramObject != null)
      return new org.bouncycastle.pqc.asn1.RainbowPrivateKey(ASN1Sequence.getInstance(paramObject)); 
    return null;
  }
  ...
  public ASN1Primitive toASN1Primitive() {
    ...
    for (byte b1 = 0; b1 < this.invA1.length; b1++)
      aSN1EncodableVector2.add(new DEROctetString(this.invA1[b1])); 
    ...
    for (byte b2 = 0; b2 < this.invA2.length; b2++)
      aSN1EncodableVector4.add(new DEROctetString(this.invA2[b2])); 
    ...
    for (byte b3 = 0; b3 < this.layers.length; b3++) {
      ...
      for (byte b4 = 0; b4 < arrayOfByte1.length; b4++) {
        ...
        for (byte b = 0; b < (arrayOfByte1[b4]).length; b++)
          aSN1EncodableVector.add(new DEROctetString(arrayOfByte1[b4][b])); 
      ...
      for (byte b5 = 0; b5 < arrayOfByte2.length; b5++) {
        ...
        for (byte b = 0; b < (arrayOfByte2[b5]).length; b++)
          aSN1EncodableVector.add(new DEROctetString(arrayOfByte2[b5][b])); 
      ...
      for (byte b6 = 0; b6 < arrayOfByte.length; b6++)
        aSN1EncodableVector11.add(new DEROctetString(arrayOfByte[b6])); 
      aSN1EncodableVector8.add(new DERSequence(aSN1EncodableVector11));
      aSN1EncodableVector8.add(new DEROctetString(RainbowUtil.convertArray(this.layers[b3].getCoeffEta())));
