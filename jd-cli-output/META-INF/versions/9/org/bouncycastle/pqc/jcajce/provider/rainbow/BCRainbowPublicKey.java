...
public class BCRainbowPublicKey implements PublicKey {
  ...
  public BCRainbowPublicKey(RainbowPublicKeySpec paramRainbowPublicKeySpec) {
    this(paramRainbowPublicKeySpec.getDocLength(), paramRainbowPublicKeySpec.getCoeffQuadratic(), paramRainbowPublicKeySpec
        .getCoeffSingular(), paramRainbowPublicKeySpec.getCoeffScalar());
  }
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == null || !(paramObject instanceof org.bouncycastle.pqc.jcajce.provider.rainbow.BCRainbowPublicKey))
      return false; 
    org.bouncycastle.pqc.jcajce.provider.rainbow.BCRainbowPublicKey bCRainbowPublicKey = (org.bouncycastle.pqc.jcajce.provider.rainbow.BCRainbowPublicKey)paramObject;
    return (this.docLength == bCRainbowPublicKey.getDocLength() && 
      RainbowUtil.equals(this.coeffquadratic, bCRainbowPublicKey.getCoeffQuadratic()) && 
      RainbowUtil.equals(this.coeffsingular, bCRainbowPublicKey.getCoeffSingular()) && 
      RainbowUtil.equals(this.coeffscalar, bCRainbowPublicKey.getCoeffScalar()));
  }
  
  public int hashCode() {
    int i = this.docLength;
    i = i * 37 + Arrays.hashCode(this.coeffquadratic);
    i = i * 37 + Arrays.hashCode(this.coeffsingular);
    i = i * 37 + Arrays.hashCode(this.coeffscalar);
    return i;
  }
