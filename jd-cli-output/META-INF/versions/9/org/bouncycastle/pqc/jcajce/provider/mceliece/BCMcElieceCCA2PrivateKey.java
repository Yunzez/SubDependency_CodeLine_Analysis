...
public class BCMcElieceCCA2PrivateKey implements PrivateKey {
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == null || !(paramObject instanceof org.bouncycastle.pqc.jcajce.provider.mceliece.BCMcElieceCCA2PrivateKey))
      return false; 
    org.bouncycastle.pqc.jcajce.provider.mceliece.BCMcElieceCCA2PrivateKey bCMcElieceCCA2PrivateKey = (org.bouncycastle.pqc.jcajce.provider.mceliece.BCMcElieceCCA2PrivateKey)paramObject;
    return (getN() == bCMcElieceCCA2PrivateKey.getN() && getK() == bCMcElieceCCA2PrivateKey.getK() && 
      getField().equals(bCMcElieceCCA2PrivateKey.getField()) && 
      getGoppaPoly().equals(bCMcElieceCCA2PrivateKey.getGoppaPoly()) && getP().equals(bCMcElieceCCA2PrivateKey.getP()) && 
      getH().equals(bCMcElieceCCA2PrivateKey.getH()));
  }
