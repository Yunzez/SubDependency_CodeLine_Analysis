...
public class BCRainbowPrivateKey implements PrivateKey {
  ...
  public BCRainbowPrivateKey(RainbowPrivateKeySpec paramRainbowPrivateKeySpec) {
    this(paramRainbowPrivateKeySpec.getInvA1(), paramRainbowPrivateKeySpec.getB1(), paramRainbowPrivateKeySpec.getInvA2(), paramRainbowPrivateKeySpec
        .getB2(), paramRainbowPrivateKeySpec.getVi(), paramRainbowPrivateKeySpec.getLayers());
  }
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == null || !(paramObject instanceof org.bouncycastle.pqc.jcajce.provider.rainbow.BCRainbowPrivateKey))
      return false; 
    org.bouncycastle.pqc.jcajce.provider.rainbow.BCRainbowPrivateKey bCRainbowPrivateKey = (org.bouncycastle.pqc.jcajce.provider.rainbow.BCRainbowPrivateKey)paramObject;
    boolean bool = true;
  ...
  public byte[] getEncoded() {
    ...
    try {
      ...
      privateKeyInfo = new PrivateKeyInfo(algorithmIdentifier, rainbowPrivateKey);
