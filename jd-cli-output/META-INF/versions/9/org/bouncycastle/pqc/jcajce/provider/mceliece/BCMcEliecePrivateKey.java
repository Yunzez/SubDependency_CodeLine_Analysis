...
public class BCMcEliecePrivateKey implements CipherParameters, PrivateKey {
  ...
  public boolean equals(Object paramObject) {
    if (!(paramObject instanceof org.bouncycastle.pqc.jcajce.provider.mceliece.BCMcEliecePrivateKey))
      return false; 
    org.bouncycastle.pqc.jcajce.provider.mceliece.BCMcEliecePrivateKey bCMcEliecePrivateKey = (org.bouncycastle.pqc.jcajce.provider.mceliece.BCMcEliecePrivateKey)paramObject;
    return (getN() == bCMcEliecePrivateKey.getN() && getK() == bCMcEliecePrivateKey.getK() && 
      getField().equals(bCMcEliecePrivateKey.getField()) && 
      getGoppaPoly().equals(bCMcEliecePrivateKey.getGoppaPoly()) && 
      getSInv().equals(bCMcEliecePrivateKey.getSInv()) && getP1().equals(bCMcEliecePrivateKey.getP1()) && 
      getP2().equals(bCMcEliecePrivateKey.getP2()));
  }
  ...
  public byte[] getEncoded() {
    ...
    try {
      ...
      privateKeyInfo = new PrivateKeyInfo(algorithmIdentifier, mcEliecePrivateKey);
