...
public class GF2Matrix extends Matrix {
  ...
  private void assignRandomRegularMatrix(int paramInt, SecureRandom paramSecureRandom) {
    ...
    this.length = paramInt + 31 >>> 5;
    this.matrix = new int[this.numRows][this.length];
    org.bouncycastle.pqc.math.linearalgebra.GF2Matrix gF2Matrix1 = new org.bouncycastle.pqc.math.linearalgebra.GF2Matrix(paramInt, 'L', paramSecureRandom);
    org.bouncycastle.pqc.math.linearalgebra.GF2Matrix gF2Matrix2 = new org.bouncycastle.pqc.math.linearalgebra.GF2Matrix(paramInt, 'U', paramSecureRandom);
    org.bouncycastle.pqc.math.linearalgebra.GF2Matrix gF2Matrix3 = (org.bouncycastle.pqc.math.linearalgebra.GF2Matrix)gF2Matrix1.rightMultiply(gF2Matrix2);
  ...
  public static org.bouncycastle.pqc.math.linearalgebra.GF2Matrix[] createRandomRegularMatrixAndItsInverse(int paramInt, SecureRandom paramSecureRandom) {
    org.bouncycastle.pqc.math.linearalgebra.GF2Matrix[] arrayOfGF2Matrix = new org.bouncycastle.pqc.math.linearalgebra.GF2Matrix[2];
    int i = paramInt + 31 >> 5;
    org.bouncycastle.pqc.math.linearalgebra.GF2Matrix gF2Matrix1 = new org.bouncycastle.pqc.math.linearalgebra.GF2Matrix(paramInt, 'L', paramSecureRandom);
    org.bouncycastle.pqc.math.linearalgebra.GF2Matrix gF2Matrix2 = new org.bouncycastle.pqc.math.linearalgebra.GF2Matrix(paramInt, 'U', paramSecureRandom);
    org.bouncycastle.pqc.math.linearalgebra.GF2Matrix gF2Matrix3 = (org.bouncycastle.pqc.math.linearalgebra.GF2Matrix)gF2Matrix1.rightMultiply(gF2Matrix2);
    ...
    arrayOfGF2Matrix[0] = new org.bouncycastle.pqc.math.linearalgebra.GF2Matrix(paramInt, arrayOfInt1);
    org.bouncycastle.pqc.math.linearalgebra.GF2Matrix gF2Matrix4 = new org.bouncycastle.pqc.math.linearalgebra.GF2Matrix(paramInt, 'I');
    ...
    org.bouncycastle.pqc.math.linearalgebra.GF2Matrix gF2Matrix5 = new org.bouncycastle.pqc.math.linearalgebra.GF2Matrix(paramInt, 'I');
    ...
    arrayOfGF2Matrix[1] = (org.bouncycastle.pqc.math.linearalgebra.GF2Matrix)gF2Matrix5.rightMultiply(gF2Matrix4.rightMultiply(permutation));
  ...
  public org.bouncycastle.pqc.math.linearalgebra.GF2Matrix getLeftSubMatrix() {
    ...
    return new org.bouncycastle.pqc.math.linearalgebra.GF2Matrix(this.numRows, arrayOfInt);
  }
  
  public org.bouncycastle.pqc.math.linearalgebra.GF2Matrix extendLeftCompactForm() {
    int i = this.numColumns + this.numRows;
    org.bouncycastle.pqc.math.linearalgebra.GF2Matrix gF2Matrix = new org.bouncycastle.pqc.math.linearalgebra.GF2Matrix(this.numRows, i);
    int j = this.numRows - 1 + this.numColumns;
    for (int k = this.numRows - 1; k >= 0; k--, j--) {
  ...
  public Matrix computeInverse() {
    ...
    return new org.bouncycastle.pqc.math.linearalgebra.GF2Matrix(this.numColumns, arrayOfInt2);
  }
  ...
  public Matrix leftMultiply(Permutation paramPermutation) {
    ...
    return new org.bouncycastle.pqc.math.linearalgebra.GF2Matrix(this.numRows, arrayOfInt1);
  }
  ...
  public Matrix rightMultiply(Matrix paramMatrix) {
    int i;
    if (!(paramMatrix instanceof org.bouncycastle.pqc.math.linearalgebra.GF2Matrix))
      throw new ArithmeticException("matrix is not defined over GF(2)"); 
    if (paramMatrix.numRows != this.numColumns)
      throw new ArithmeticException("length mismatch"); 
    org.bouncycastle.pqc.math.linearalgebra.GF2Matrix gF2Matrix1 = (org.bouncycastle.pqc.math.linearalgebra.GF2Matrix)paramMatrix;
    org.bouncycastle.pqc.math.linearalgebra.GF2Matrix gF2Matrix2 = new org.bouncycastle.pqc.math.linearalgebra.GF2Matrix(this.numRows, paramMatrix.numColumns);
  ...
  public boolean equals(Object paramObject) {
    if (!(paramObject instanceof org.bouncycastle.pqc.math.linearalgebra.GF2Matrix))
      return false; 
    org.bouncycastle.pqc.math.linearalgebra.GF2Matrix gF2Matrix = (org.bouncycastle.pqc.math.linearalgebra.GF2Matrix)paramObject;
