...
public class GF2Vector extends Vector {
  ...
  public static org.bouncycastle.pqc.math.linearalgebra.GF2Vector OS2VP(int paramInt, byte[] paramArrayOfbyte) {
    ...
    if (paramArrayOfbyte.length > i)
      throw new ArithmeticException("length mismatch"); 
    return new org.bouncycastle.pqc.math.linearalgebra.GF2Vector(paramInt, LittleEndianConversions.toIntArray(paramArrayOfbyte));
  }
  ...
  public Vector add(Vector paramVector) {
    if (!(paramVector instanceof org.bouncycastle.pqc.math.linearalgebra.GF2Vector))
      throw new ArithmeticException("vector is not defined over GF(2)"); 
    org.bouncycastle.pqc.math.linearalgebra.GF2Vector gF2Vector = (org.bouncycastle.pqc.math.linearalgebra.GF2Vector)paramVector;
    if (this.length != gF2Vector.length)
      throw new ArithmeticException("length mismatch"); 
    int[] arrayOfInt = IntUtils.clone(((org.bouncycastle.pqc.math.linearalgebra.GF2Vector)paramVector).v);
    for (int i = arrayOfInt.length - 1; i >= 0; i--)
      arrayOfInt[i] = arrayOfInt[i] ^ this.v[i]; 
    return new org.bouncycastle.pqc.math.linearalgebra.GF2Vector(this.length, arrayOfInt);
  }
  ...
  public org.bouncycastle.pqc.math.linearalgebra.GF2Vector extractLeftVector(int paramInt) {
    ...
    org.bouncycastle.pqc.math.linearalgebra.GF2Vector gF2Vector = new org.bouncycastle.pqc.math.linearalgebra.GF2Vector(paramInt);
    int i = paramInt >> 5;
    int j = paramInt & 0x1F;
  ...
  public boolean equals(Object paramObject) {
    if (!(paramObject instanceof org.bouncycastle.pqc.math.linearalgebra.GF2Vector))
      return false; 
    org.bouncycastle.pqc.math.linearalgebra.GF2Vector gF2Vector = (org.bouncycastle.pqc.math.linearalgebra.GF2Vector)paramObject;
    return (this.length == gF2Vector.length && IntUtils.equals(this.v, gF2Vector.v));
  }
  
  public int hashCode() {
    int i = this.length;
    i = i * 31 + Arrays.hashCode(this.v);
    return i;
  }
