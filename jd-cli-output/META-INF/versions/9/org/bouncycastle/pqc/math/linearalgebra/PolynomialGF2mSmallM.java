...
public class PolynomialGF2mSmallM {
  ...
  public org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM add(org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM paramPolynomialGF2mSmallM) {
    ...
    return new org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM(this.field, arrayOfInt);
  }
  ...
  public org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM addMonomial(int paramInt) {
    ...
    return new org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM(this.field, arrayOfInt2);
  }
  ...
  public org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM[] div(org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM paramPolynomialGF2mSmallM) {
    ...
    return new org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM[] { new org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM(this.field, arrayOfInt[0]), new org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM(this.field, arrayOfInt[1]) };
  }
  ...
  public org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM modSquareMatrix(org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM[] paramArrayOfPolynomialGF2mSmallM) {
    ...
    return new org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM(this.field, arrayOfInt1);
  }
  ...
  public org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM modSquareRoot(org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM paramPolynomialGF2mSmallM) {
    ...
    int[] arrayOfInt2 = modMultiply(arrayOfInt1, arrayOfInt1, paramPolynomialGF2mSmallM.coefficients);
    while (!isEqual(arrayOfInt2, this.coefficients)) {
      arrayOfInt1 = normalForm(arrayOfInt2);
      arrayOfInt2 = modMultiply(arrayOfInt1, arrayOfInt1, paramPolynomialGF2mSmallM.coefficients);
    } 
    return new org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM(this.field, arrayOfInt1);
  }
  ...
  public org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM modSquareRootMatrix(org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM[] paramArrayOfPolynomialGF2mSmallM) {
    ...
    for (b = 0; b < i; b++) {
      for (byte b1 = 0; b1 < i; b1++) {
        if (b < (paramArrayOfPolynomialGF2mSmallM[b1]).coefficients.length)
          if (b1 < this.coefficients.length) {
  ...
  private int[] modDiv(int[] paramArrayOfint1, int[] paramArrayOfint2, int[] paramArrayOfint3) {
    ...
    int[] arrayOfInt3 = { 0 };
    int[] arrayOfInt4 = mod(paramArrayOfint1, paramArrayOfint3);
    while (computeDegree(arrayOfInt2) != -1) {
      int[][] arrayOfInt5 = div(arrayOfInt1, arrayOfInt2);
      arrayOfInt1 = normalForm(arrayOfInt2);
      arrayOfInt2 = normalForm(arrayOfInt5[1]);
      int[] arrayOfInt = add(arrayOfInt3, modMultiply(arrayOfInt5[0], arrayOfInt4, paramArrayOfint3));
      arrayOfInt3 = normalForm(arrayOfInt4);
      arrayOfInt4 = normalForm(arrayOfInt);
    } 
    int i = headCoefficient(arrayOfInt1);
    arrayOfInt3 = multWithElement(arrayOfInt3, this.field.inverse(i));
    return arrayOfInt3;
  }
  ...
  public org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM[] modPolynomialToFracton(org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM paramPolynomialGF2mSmallM) {
    ...
    int[] arrayOfInt3 = { 0 };
    int[] arrayOfInt4 = { 1 };
    while (computeDegree(arrayOfInt2) > i) {
    ...
    return new org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM[] { new org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM(this.field, arrayOfInt2), new org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM(this.field, arrayOfInt4) };
  }
  
  public boolean equals(Object paramObject) {
    if (paramObject == null || !(paramObject instanceof org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM))
      return false; 
    org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM polynomialGF2mSmallM = (org.bouncycastle.pqc.math.linearalgebra.PolynomialGF2mSmallM)paramObject;
    if (this.field.equals(polynomialGF2mSmallM.field) && this.degree == polynomialGF2mSmallM.degree && 
      isEqual(this.coefficients, polynomialGF2mSmallM.coefficients))
      return true; 
    return false;
  }
  ...
  public String toString() {
    ...
    for (byte b = 0; b < this.coefficients.length; b++)
      str = str + str + "Y^" + this.field.elementToStr(this.coefficients[b]) + "+"; 
    str = str + ";";
    return str;
  }
  ...
  private void computeDegree() {
    ...
    for (; this.degree >= 0 && this.coefficients[this.degree] == 0; this.degree--);
  }
