...
public class GF2mField {
  ...
  public boolean isElementOfThisField(int paramInt) {
    if (this.degree == 31)
      return (paramInt >= 0); 
    return (paramInt >= 0 && paramInt < 1 << this.degree);
  }
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == null || !(paramObject instanceof org.bouncycastle.pqc.math.linearalgebra.GF2mField))
      return false; 
    org.bouncycastle.pqc.math.linearalgebra.GF2mField gF2mField = (org.bouncycastle.pqc.math.linearalgebra.GF2mField)paramObject;
  ...
  public String toString() {
    return "Finite Field GF(2^" + this.degree + ") = GF(2)[X]/<" + 
