...
public class Layer {
  ...
  public boolean equals(Object paramObject) {
    if (paramObject == null || !(paramObject instanceof org.bouncycastle.pqc.crypto.rainbow.Layer))
      return false; 
    org.bouncycastle.pqc.crypto.rainbow.Layer layer = (org.bouncycastle.pqc.crypto.rainbow.Layer)paramObject;
    return (this.vi == layer.getVi() && this.viNext == layer
      .getViNext() && this.oi == layer
      .getOi() && 
      RainbowUtil.equals(this.coeff_alpha, layer.getCoeffAlpha()) && 
      RainbowUtil.equals(this.coeff_beta, layer.getCoeffBeta()) && 
      RainbowUtil.equals(this.coeff_gamma, layer.getCoeffGamma()) && 
      RainbowUtil.equals(this.coeff_eta, layer.getCoeffEta()));
  }
  ...
  public int hashCode() {
    ...
    i = i * 37 + this.viNext;
    i = i * 37 + this.oi;
    i = i * 37 + Arrays.hashCode(this.coeff_alpha);
    i = i * 37 + Arrays.hashCode(this.coeff_beta);
    i = i * 37 + Arrays.hashCode(this.coeff_gamma);
    i = i * 37 + Arrays.hashCode(this.coeff_eta);
    return i;
  }
}
