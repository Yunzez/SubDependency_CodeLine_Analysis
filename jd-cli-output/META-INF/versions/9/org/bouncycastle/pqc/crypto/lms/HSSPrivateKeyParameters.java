...
public class HSSPrivateKeyParameters extends LMSKeyParameters implements LMSContextBasedSigner {
  ...
  public int hashCode() {
    int i = this.l;
    i = 31 * i + (this.isShard ? 1 : 0);
    i = 31 * i + this.keys.hashCode();
    i = 31 * i + this.sig.hashCode();
    i = 31 * i + (int)(this.indexLimit ^ this.indexLimit >>> 32L);
    i = 31 * i + (int)(this.index ^ this.index >>> 32L);
    return i;
  }
  ...
  public LMSContext generateLMSContext() {
    ...
    synchronized (this) {
      ...
      while (j < i - 1) {
        arrayOfLMSSignedPubKey[j] = new LMSSignedPubKey(list1
            .get(j), ((LMSPrivateKeyParameters)list
            .get(j + 1)).getPublicKey());
        j++;
      } 
      incIndex();
    } 
