...
public abstract class ASN1External extends ASN1Primitive {
  ...
  boolean asn1Equals(ASN1Primitive paramASN1Primitive) {
    ...
    return (Objects.areEqual(this.directReference, aSN1External.directReference) && 
      Objects.areEqual(this.indirectReference, aSN1External.indirectReference) && 
      Objects.areEqual(this.dataValueDescriptor, aSN1External.dataValueDescriptor) && this.encoding == aSN1External.encoding && this.externalContent
      
      .equals(aSN1External.externalContent));
  }
  ...
  private static ASN1Primitive getExternalContent(ASN1TaggedObject paramASN1TaggedObject) {
    int i = paramASN1TaggedObject.getTagClass(), j = paramASN1TaggedObject.getTagNo();
    if (128 != i)
