...
public abstract class ASN1TaggedObject extends ASN1Primitive implements ASN1TaggedObjectParser {
  ...
  boolean asn1Equals(ASN1Primitive paramASN1Primitive) {
    if (paramASN1Primitive instanceof org.bouncycastle.asn1.ASN1ApplicationSpecific)
    ...
    if (this.tagNo != aSN1TaggedObject.tagNo || this.tagClass != aSN1TaggedObject.tagClass)
      return false; 
    if (this.explicitness != aSN1TaggedObject.explicitness)
      if (isExplicit() != aSN1TaggedObject.isExplicit())
        return false;  
    ...
    switch (this.explicitness) {
      ...
      case 4:
        if (aSN1Primitive instanceof ASN1Sequence)
          return paramASN1UniversalType.fromImplicitConstructed((ASN1Sequence)aSN1Primitive); 
        return paramASN1UniversalType.fromImplicitPrimitive((DEROctetString)aSN1Primitive);
    } 
