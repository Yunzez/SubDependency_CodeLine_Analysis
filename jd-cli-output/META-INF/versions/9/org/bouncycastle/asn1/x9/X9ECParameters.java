...
public class X9ECParameters extends ASN1Object implements X9ObjectIdentifiers {
  ...
  private X9ECParameters(ASN1Sequence paramASN1Sequence) {
    if (!(paramASN1Sequence.getObjectAt(0) instanceof ASN1Integer) || 
      !((ASN1Integer)paramASN1Sequence.getObjectAt(0)).hasValue(1))
  ...
  public static org.bouncycastle.asn1.x9.X9ECParameters getInstance(Object paramObject) {
    if (paramObject instanceof org.bouncycastle.asn1.x9.X9ECParameters)
      return (org.bouncycastle.asn1.x9.X9ECParameters)paramObject; 
    if (paramObject != null)
      return new org.bouncycastle.asn1.x9.X9ECParameters(ASN1Sequence.getInstance(paramObject)); 
    return null;
  }
