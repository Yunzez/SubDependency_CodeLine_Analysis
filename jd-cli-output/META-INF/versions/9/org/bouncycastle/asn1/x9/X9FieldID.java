...
public class X9FieldID extends ASN1Object implements X9ObjectIdentifiers {
  ...
  public static org.bouncycastle.asn1.x9.X9FieldID getInstance(Object paramObject) {
    if (paramObject instanceof org.bouncycastle.asn1.x9.X9FieldID)
      return (org.bouncycastle.asn1.x9.X9FieldID)paramObject; 
    if (paramObject != null)
      return new org.bouncycastle.asn1.x9.X9FieldID(ASN1Sequence.getInstance(paramObject)); 
    return null;
  }
