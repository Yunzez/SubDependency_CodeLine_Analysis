...
public class ECGOST3410NamedCurves {
  ...
  static {
    ...
    ECCurve eCCurve = configureCurve(new ECCurve.Fp(bigInteger1, 
          
          fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFD94"), 
          fromHex("A6"), bigInteger2, ECConstants.ONE));
    ECDomainParameters eCDomainParameters = new ECDomainParameters(eCCurve, configureBasepoint(eCCurve, ECConstants.ONE, 
          
          fromHex("8D91E471E0989CDA27DF505A453F2B7635294F2DDF23E3B122ACC99C9E9F1E14")), bigInteger2, ECConstants.ONE);
    ...
    eCCurve = configureCurve(new ECCurve.Fp(bigInteger1, 
          
          fromHex("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFD94"), 
          fromHex("A6"), bigInteger2, ECConstants.ONE));
    eCDomainParameters = new ECDomainParameters(eCCurve, configureBasepoint(eCCurve, ECConstants.ONE, 
    ...
    eCCurve = configureCurve(new ECCurve.Fp(bigInteger1, 
          ...
          fromHex("3E1AF419A269A5F866A7D3C25C3DF80AE979259373FF2B182F49D4CE7E1BBC8B"), bigInteger2, ECConstants.ONE));
    eCDomainParameters = new ECDomainParameters(eCCurve, configureBasepoint(eCCurve, ECConstants.ONE, 
          
          fromHex("3FA8124359F96680B83D1C3EB2C070E5C545C9858D03ECFB744BF8D717717EFC")), bigInteger2, ECConstants.ONE);
    ...
    eCCurve = configureCurve(new ECCurve.Fp(bigInteger1, 
          ...
          fromHex("805A"), bigInteger2, ECConstants.ONE));
    eCDomainParameters = new ECDomainParameters(eCCurve, configureBasepoint(eCCurve, ECConstants.ZERO, 
          
          fromHex("41ECE55743711A8C3CBF3783CD08C0EE4D4DC440D4641A8F366E550DFDB3BB67")), bigInteger2, ECConstants.ONE);
    ...
    eCCurve = configureCurve(new ECCurve.Fp(bigInteger1, 
          ...
          fromHex("295F9BAE7428ED9CCC20E7C359A9D41A22FCCD9108E17BF7BA9337A6F8AE9513"), bigInteger2, ECConstants.FOUR));
    eCDomainParameters = new ECDomainParameters(eCCurve, configureBasepoint(eCCurve, 
          fromHex("91E38443A5E82C0D880923425712B2BB658B9196932E02C78B2582FE742DAA28"), 
          fromHex("32879423AB1A0375895786C4BB46E9565FDE0B5344766740AF268ADB32322E5C")), bigInteger2, ECConstants.FOUR);
    ...
    eCCurve = configureCurve(new ECCurve.Fp(bigInteger1, 
          ...
          fromHex("E8C2505DEDFC86DDC1BD0B2B6667F1DA34B82574761CB0E879BD081CFD0B6265EE3CB090F30D27614CB4574010DA90DD862EF9D4EBEE4761503190785A71C760"), bigInteger2, ECConstants.ONE));
    eCDomainParameters = new ECDomainParameters(eCCurve, configureBasepoint(eCCurve, ECConstants.THREE, 
          
          fromHex("7503CFE87A836AE3A61B8816E25450E6CE5E1C93ACF1ABC1778064FDCBEFA921DF1626BE4FD036E93D75E6A50E3A41E98028FE5FC235F5B889A589CB5215F2A4")), bigInteger2, ECConstants.ONE);
    ...
    eCCurve = configureCurve(new ECCurve.Fp(bigInteger1, 
          ...
          fromHex("687D1B459DC841457E3E06CF6F5E2517B97C7D614AF138BCBF85DC806C4B289F3E965D2DB1416D217F8B276FAD1AB69C50F78BEE1FA3106EFB8CCBC7C5140116"), bigInteger2, ECConstants.ONE));
    eCDomainParameters = new ECDomainParameters(eCCurve, configureBasepoint(eCCurve, ECConstants.TWO, 
          
          fromHex("1A8F7EDA389B094C2C071E3647A8940F3C123B697578C213BE6DD9E6C8EC7335DCB228FD1EDF4A39152CBCAAF8C0398828041055F94CEEEC7E21340780FE41BD")), bigInteger2, ECConstants.ONE);
    ...
    eCCurve = configureCurve(new ECCurve.Fp(bigInteger1, 
          ...
          fromHex("B4C4EE28CEBC6C2C8AC12952CF37F16AC7EFB6A9F69F4B57FFDA2E4F0DE5ADE038CBC2FFF719D2C18DE0284B8BFEF3B52B8CC7A5F5BF0A3C8D2319A5312557E1"), bigInteger2, ECConstants.FOUR));
    eCDomainParameters = new ECDomainParameters(eCCurve, configureBasepoint(eCCurve, 
          ...
          fromHex("F5CE40D95B5EB899ABBCCFF5911CB8577939804D6527378B8C108C3D2090FF9BE18E2D33E3021ED2EF32D85822423B6304F726AA854BAE07D0396E9A9ADDC40F")), bigInteger2, ECConstants.FOUR);
  ...
  public static X9ECParameters getByOIDX9(ASN1ObjectIdentifier paramASN1ObjectIdentifier) {
    ...
    return (eCDomainParameters == null) ? null : new X9ECParameters(eCDomainParameters.getCurve(), new X9ECPoint(eCDomainParameters.getG(), false), eCDomainParameters.getN(), eCDomainParameters
        .getH(), eCDomainParameters.getSeed());
  }
