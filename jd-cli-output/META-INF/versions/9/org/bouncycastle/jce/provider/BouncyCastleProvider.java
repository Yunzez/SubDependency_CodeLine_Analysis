...
public final class BouncyCastleProvider extends Provider implements ConfigurableProvider {
  ...
  private void loadAlgorithms(String paramString, String[] paramArrayOfString) {
    for (byte b = 0; b != paramArrayOfString.length; b++) {
      Class<AlgorithmProvider> clazz = ClassUtil.loadClass(org.bouncycastle.jce.provider.BouncyCastleProvider.class, paramString + paramString + "$Mappings");
      if (clazz != null)
        try {
  ...
  public static PublicKey getPublicKey(SubjectPublicKeyInfo paramSubjectPublicKeyInfo) throws IOException {
    ...
    if (asymmetricKeyInfoConverter == null)
      return null; 
    return asymmetricKeyInfoConverter.generatePublic(paramSubjectPublicKeyInfo);
  }
  ...
  public static PrivateKey getPrivateKey(PrivateKeyInfo paramPrivateKeyInfo) throws IOException {
    ...
    if (asymmetricKeyInfoConverter == null)
      return null; 
    return asymmetricKeyInfoConverter.generatePrivate(paramPrivateKeyInfo);
  }
}
