...
public abstract class Nat224 {
  ...
  public static void mul(int[] paramArrayOfint1, int[] paramArrayOfint2, int[] paramArrayOfint3) {
    ...
    long l8 = 0L, l9 = paramArrayOfint1[0] & 0xFFFFFFFFL;
    l8 += l9 * l1;
  ...
  public static void mul(int[] paramArrayOfint1, int paramInt1, int[] paramArrayOfint2, int paramInt2, int[] paramArrayOfint3, int paramInt3) {
    ...
    long l8 = 0L, l9 = paramArrayOfint1[paramInt1 + 0] & 0xFFFFFFFFL;
    l8 += l9 * l1;
  ...
  public static void square(int[] paramArrayOfint1, int[] paramArrayOfint2) {
    ...
    byte b1 = 6, b2 = 14;
    do {
      long l20 = paramArrayOfint1[b1--] & 0xFFFFFFFFL;
      long l21 = l20 * l20;
      paramArrayOfint2[--b2] = i << 31 | (int)(l21 >>> 33L);
      paramArrayOfint2[--b2] = (int)(l21 >>> 1L);
      i = (int)l21;
    } while (b1 > 0);
    long l4 = l1 * l1;
    ...
    i = j >>> 31;
    j = paramArrayOfint2[13] + (int)(l19 >>> 32L);
  ...
  public static void square(int[] paramArrayOfint1, int paramInt1, int[] paramArrayOfint2, int paramInt2) {
    ...
    byte b1 = 6, b2 = 14;
    do {
      long l20 = paramArrayOfint1[paramInt1 + b1--] & 0xFFFFFFFFL;
      long l21 = l20 * l20;
      paramArrayOfint2[paramInt2 + --b2] = i << 31 | (int)(l21 >>> 33L);
      paramArrayOfint2[paramInt2 + --b2] = (int)(l21 >>> 1L);
      i = (int)l21;
    } while (b1 > 0);
    long l4 = l1 * l1;
    long l2 = (i << 31) & 0xFFFFFFFFL | l4 >>> 33L;
    ...
    i = j >>> 31;
    j = paramArrayOfint2[paramInt2 + 13] + (int)(l19 >>> 32L);
