...
public class SecP192R1Field {
  ...
  public static void reduce(int[] paramArrayOfint1, int[] paramArrayOfint2) {
    long l1 = paramArrayOfint1[6] & 0xFFFFFFFFL, l2 = paramArrayOfint1[7] & 0xFFFFFFFFL, l3 = paramArrayOfint1[8] & 0xFFFFFFFFL;
    long l4 = paramArrayOfint1[9] & 0xFFFFFFFFL, l5 = paramArrayOfint1[10] & 0xFFFFFFFFL, l6 = paramArrayOfint1[11] & 0xFFFFFFFFL;
    long l7 = l1 + l5;
    long l8 = l2 + l6;
    long l9 = 0L;
    ...
    l9 = l10 >> 32L;
    if ((l9 != 0L && Nat.incAt(6, paramArrayOfint2, 3) != 0) || (paramArrayOfint2[5] == -1 && 
      Nat192.gte(paramArrayOfint2, P)))
      addPInvTo(paramArrayOfint2); 
  }
  ...
  public static void reduce32(int paramInt, int[] paramArrayOfint) {
    ...
    if ((l != 0L && Nat.incAt(6, paramArrayOfint, 3) != 0) || (paramArrayOfint[5] == -1 && 
