...
public class WTauNafMultiplier extends AbstractECMultiplier {
  ...
  private ECPoint.AbstractF2m multiplyWTnaf(ECPoint.AbstractF2m paramAbstractF2m, ZTauElement paramZTauElement, byte paramByte1, byte paramByte2) {
    ...
    byte[] arrayOfByte = Tnaf.tauAdicWNaf(paramByte2, paramZTauElement, (byte)4, 
        BigInteger.valueOf(16L), bigInteger, arrayOfZTauElement);
  ...
  private static ECPoint.AbstractF2m multiplyFromWTnaf(ECPoint.AbstractF2m paramAbstractF2m, byte[] paramArrayOfbyte) {
    ...
    WTauNafPreCompInfo wTauNafPreCompInfo = (WTauNafPreCompInfo)abstractF2m.precompute(paramAbstractF2m, "bc_wtnaf", (PreCompCallback)new Object(paramAbstractF2m, b));
