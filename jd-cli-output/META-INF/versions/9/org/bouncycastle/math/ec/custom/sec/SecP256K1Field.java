...
public class SecP256K1Field {
  ...
  public static void addExt(int[] paramArrayOfint1, int[] paramArrayOfint2, int[] paramArrayOfint3) {
    ...
    if (i != 0 || (paramArrayOfint3[15] == -1 && Nat.gte(16, paramArrayOfint3, PExt)))
  ...
  public static void reduce32(int paramInt, int[] paramArrayOfint) {
    if ((paramInt != 0 && Nat256.mul33WordAdd(977, paramInt, paramArrayOfint, 0) != 0) || (paramArrayOfint[7] == -1 && 
      Nat256.gte(paramArrayOfint, P)))
