...
public class SM2P256V1Point extends ECPoint.AbstractFp {
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    SM2P256V1FieldElement sM2P256V1FieldElement1 = (SM2P256V1FieldElement)this.x, sM2P256V1FieldElement2 = (SM2P256V1FieldElement)this.y;
    SM2P256V1FieldElement sM2P256V1FieldElement3 = (SM2P256V1FieldElement)paramECPoint.getXCoord(), sM2P256V1FieldElement4 = (SM2P256V1FieldElement)paramECPoint.getYCoord();
    ...
    return new org.bouncycastle.math.ec.custom.gm.SM2P256V1Point(eCCurve, sM2P256V1FieldElement7, sM2P256V1FieldElement8, arrayOfECFieldElement);
  }
  ...
  public ECPoint twice() {
    ...
    if (sM2P256V1FieldElement1.isZero())
      return eCCurve.getInfinity(); 
    SM2P256V1FieldElement sM2P256V1FieldElement2 = (SM2P256V1FieldElement)this.x, sM2P256V1FieldElement3 = (SM2P256V1FieldElement)this.zs[0];
    ...
    return new org.bouncycastle.math.ec.custom.gm.SM2P256V1Point(eCCurve, sM2P256V1FieldElement4, sM2P256V1FieldElement5, new ECFieldElement[] { sM2P256V1FieldElement6 });
  }
  ...
  public ECPoint negate() {
    if (isInfinity())
      return this; 
    return new org.bouncycastle.math.ec.custom.gm.SM2P256V1Point(this.curve, this.x, this.y.negate(), this.zs);
  }
}
