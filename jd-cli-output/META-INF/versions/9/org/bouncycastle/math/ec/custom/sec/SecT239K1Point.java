...
public class SecT239K1Point extends ECPoint.AbstractF2m {
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    if (eCFieldElement2.isZero()) {
      ...
      if (eCFieldElement13.isZero())
        return new org.bouncycastle.math.ec.custom.sec.SecT239K1Point(eCCurve, eCFieldElement13, eCCurve.getB()); 
    ...
    return new org.bouncycastle.math.ec.custom.sec.SecT239K1Point(eCCurve, eCFieldElement13, eCFieldElement14, new ECFieldElement[] { eCFieldElement15 });
  }
  ...
  public ECPoint twice() {
    ...
    if (eCFieldElement5.isZero())
      return new org.bouncycastle.math.ec.custom.sec.SecT239K1Point(eCCurve, eCFieldElement5, eCCurve.getB()); 
    ...
    return new org.bouncycastle.math.ec.custom.sec.SecT239K1Point(eCCurve, eCFieldElement6, eCFieldElement10, new ECFieldElement[] { eCFieldElement7 });
  }
  ...
  public ECPoint twicePlus(ECPoint paramECPoint) {
    ...
    return new org.bouncycastle.math.ec.custom.sec.SecT239K1Point(eCCurve, eCFieldElement16, eCFieldElement18, new ECFieldElement[] { eCFieldElement17 });
  }
  ...
  public ECPoint negate() {
    ...
    if (eCFieldElement1.isZero())
      return this; 
    ECFieldElement eCFieldElement2 = this.y, eCFieldElement3 = this.zs[0];
    return new org.bouncycastle.math.ec.custom.sec.SecT239K1Point(this.curve, eCFieldElement1, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[] { eCFieldElement3 });
  }
}
