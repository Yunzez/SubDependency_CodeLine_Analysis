...
public class SecP224R1Field {
  ...
  public static void addExt(int[] paramArrayOfint1, int[] paramArrayOfint2, int[] paramArrayOfint3) {
    ...
    if (i != 0 || (paramArrayOfint3[13] == -1 && Nat.gte(14, paramArrayOfint3, PExt)))
  ...
  public static void reduce(int[] paramArrayOfint1, int[] paramArrayOfint2) {
    long l1 = paramArrayOfint1[10] & 0xFFFFFFFFL, l2 = paramArrayOfint1[11] & 0xFFFFFFFFL, l3 = paramArrayOfint1[12] & 0xFFFFFFFFL, l4 = paramArrayOfint1[13] & 0xFFFFFFFFL;
    ...
    l8 = l10 >> 32L;
    if ((l8 != 0L && Nat.incAt(7, paramArrayOfint2, 4) != 0) || (paramArrayOfint2[6] == -1 && 
      Nat224.gte(paramArrayOfint2, P)))
      addPInvTo(paramArrayOfint2); 
  }
  ...
  public static void reduce32(int paramInt, int[] paramArrayOfint) {
    ...
    if ((l != 0L && Nat.incAt(7, paramArrayOfint, 4) != 0) || (paramArrayOfint[6] == -1 && 
      Nat224.gte(paramArrayOfint, P)))
