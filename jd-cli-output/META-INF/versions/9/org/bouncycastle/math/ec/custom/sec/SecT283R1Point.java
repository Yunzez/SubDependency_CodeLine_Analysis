...
public class SecT283R1Point extends ECPoint.AbstractF2m {
  ...
  protected ECPoint detach() {
    return new org.bouncycastle.math.ec.custom.sec.SecT283R1Point(null, getAffineXCoord(), getAffineYCoord());
  }
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    if (eCFieldElement2.isZero()) {
      ...
      if (eCFieldElement13.isZero())
        return new org.bouncycastle.math.ec.custom.sec.SecT283R1Point(eCCurve, eCFieldElement13, eCCurve.getB().sqrt()); 
    ...
    return new org.bouncycastle.math.ec.custom.sec.SecT283R1Point(eCCurve, eCFieldElement13, eCFieldElement14, new ECFieldElement[] { eCFieldElement15 });
  }
  ...
  public ECPoint twice() {
    ...
    if (eCFieldElement6.isZero())
      return new org.bouncycastle.math.ec.custom.sec.SecT283R1Point(eCCurve, eCFieldElement6, eCCurve.getB().sqrt()); 
    ...
    return new org.bouncycastle.math.ec.custom.sec.SecT283R1Point(eCCurve, eCFieldElement7, eCFieldElement10, new ECFieldElement[] { eCFieldElement8 });
  }
  ...
  public ECPoint twicePlus(ECPoint paramECPoint) {
    ...
    if (eCFieldElement12.isZero())
      return new org.bouncycastle.math.ec.custom.sec.SecT283R1Point(eCCurve, eCFieldElement12, eCCurve.getB().sqrt()); 
    ...
    return new org.bouncycastle.math.ec.custom.sec.SecT283R1Point(eCCurve, eCFieldElement15, eCFieldElement17, new ECFieldElement[] { eCFieldElement16 });
  }
  ...
  public ECPoint negate() {
    ...
    if (eCFieldElement1.isZero())
      return this; 
    ECFieldElement eCFieldElement2 = this.y, eCFieldElement3 = this.zs[0];
    return new org.bouncycastle.math.ec.custom.sec.SecT283R1Point(this.curve, eCFieldElement1, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[] { eCFieldElement3 });
  }
}
