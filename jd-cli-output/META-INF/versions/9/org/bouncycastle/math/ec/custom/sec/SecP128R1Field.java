...
public class SecP128R1Field {
  ...
  public static void reduce(int[] paramArrayOfint1, int[] paramArrayOfint2) {
    long l1 = paramArrayOfint1[0] & 0xFFFFFFFFL, l2 = paramArrayOfint1[1] & 0xFFFFFFFFL, l3 = paramArrayOfint1[2] & 0xFFFFFFFFL, l4 = paramArrayOfint1[3] & 0xFFFFFFFFL;
    long l5 = paramArrayOfint1[4] & 0xFFFFFFFFL, l6 = paramArrayOfint1[5] & 0xFFFFFFFFL, l7 = paramArrayOfint1[6] & 0xFFFFFFFFL, l8 = paramArrayOfint1[7] & 0xFFFFFFFFL;
    l4 += l8;
    l7 += l8 << 1L;
    l3 += l7;
    l6 += l7 << 1L;
