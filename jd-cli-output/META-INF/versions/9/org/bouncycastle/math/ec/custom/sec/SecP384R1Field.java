...
public class SecP384R1Field {
  ...
  public static void addExt(int[] paramArrayOfint1, int[] paramArrayOfint2, int[] paramArrayOfint3) {
    ...
    if (i != 0 || (paramArrayOfint3[23] == -1 && Nat.gte(24, paramArrayOfint3, PExt)))
  ...
  public static void reduce(int[] paramArrayOfint1, int[] paramArrayOfint2) {
    long l1 = paramArrayOfint1[16] & 0xFFFFFFFFL, l2 = paramArrayOfint1[17] & 0xFFFFFFFFL, l3 = paramArrayOfint1[18] & 0xFFFFFFFFL, l4 = paramArrayOfint1[19] & 0xFFFFFFFFL;
    long l5 = paramArrayOfint1[20] & 0xFFFFFFFFL, l6 = paramArrayOfint1[21] & 0xFFFFFFFFL, l7 = paramArrayOfint1[22] & 0xFFFFFFFFL, l8 = paramArrayOfint1[23] & 0xFFFFFFFFL;
  ...
  public static void reduce32(int paramInt, int[] paramArrayOfint) {
    ...
    if ((l != 0L && Nat.incAt(12, paramArrayOfint, 5) != 0) || (paramArrayOfint[11] == -1 && 
      Nat.gte(12, paramArrayOfint, P)))
