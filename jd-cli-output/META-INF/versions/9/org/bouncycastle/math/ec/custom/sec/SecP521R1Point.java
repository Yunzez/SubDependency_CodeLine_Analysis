...
public class SecP521R1Point extends ECPoint.AbstractFp {
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    SecP521R1FieldElement secP521R1FieldElement1 = (SecP521R1FieldElement)this.x, secP521R1FieldElement2 = (SecP521R1FieldElement)this.y;
    SecP521R1FieldElement secP521R1FieldElement3 = (SecP521R1FieldElement)paramECPoint.getXCoord(), secP521R1FieldElement4 = (SecP521R1FieldElement)paramECPoint.getYCoord();
    ...
    return new org.bouncycastle.math.ec.custom.sec.SecP521R1Point(eCCurve, secP521R1FieldElement7, secP521R1FieldElement8, arrayOfECFieldElement);
  }
  ...
  public ECPoint twice() {
    ...
    if (secP521R1FieldElement1.isZero())
      return eCCurve.getInfinity(); 
    SecP521R1FieldElement secP521R1FieldElement2 = (SecP521R1FieldElement)this.x, secP521R1FieldElement3 = (SecP521R1FieldElement)this.zs[0];
    int[] arrayOfInt1 = Nat.create(17);
    int[] arrayOfInt2 = Nat.create(17);
    int[] arrayOfInt3 = Nat.create(17);
    ...
    return new org.bouncycastle.math.ec.custom.sec.SecP521R1Point(eCCurve, secP521R1FieldElement4, secP521R1FieldElement5, new ECFieldElement[] { secP521R1FieldElement6 });
  }
  ...
  public ECPoint negate() {
    if (isInfinity())
      return this; 
    return new org.bouncycastle.math.ec.custom.sec.SecP521R1Point(this.curve, this.x, this.y.negate(), this.zs);
  }
}
