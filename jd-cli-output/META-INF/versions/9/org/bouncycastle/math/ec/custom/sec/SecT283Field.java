...
public class SecT283Field {
  ...
  public static void reduce(long[] paramArrayOflong1, long[] paramArrayOflong2) {
    ...
    long l6 = paramArrayOflong1[5], l7 = paramArrayOflong1[6], l8 = paramArrayOflong1[7], l9 = paramArrayOflong1[8];
  ...
  public static void reduce37(long[] paramArrayOflong, int paramInt) {
    long l1 = paramArrayOflong[paramInt + 4], l2 = l1 >>> 27L;
  ...
  protected static void implCompactExt(long[] paramArrayOflong) {
    long l1 = paramArrayOflong[0], l2 = paramArrayOflong[1], l3 = paramArrayOflong[2], l4 = paramArrayOflong[3], l5 = paramArrayOflong[4];
    long l6 = paramArrayOflong[5], l7 = paramArrayOflong[6], l8 = paramArrayOflong[7], l9 = paramArrayOflong[8], l10 = paramArrayOflong[9];
  ...
  protected static void implMultiply(long[] paramArrayOflong1, long[] paramArrayOflong2, long[] paramArrayOflong3) {
    long[] arrayOfLong1 = new long[5], arrayOfLong2 = new long[5];
    ...
    long l1 = arrayOfLong1[0] ^ arrayOfLong1[1], l2 = arrayOfLong2[0] ^ arrayOfLong2[1];
    long l3 = arrayOfLong1[0] ^ arrayOfLong1[2], l4 = arrayOfLong2[0] ^ arrayOfLong2[2];
    long l5 = arrayOfLong1[2] ^ arrayOfLong1[4], l6 = arrayOfLong2[2] ^ arrayOfLong2[4];
    long l7 = arrayOfLong1[3] ^ arrayOfLong1[4], l8 = arrayOfLong2[3] ^ arrayOfLong2[4];
    ...
    long l9 = l1 ^ l7, l10 = l2 ^ l8;
    long l11 = l9 ^ arrayOfLong1[2], l12 = l10 ^ arrayOfLong2[2];
  ...
  protected static void implMulw(long[] paramArrayOflong1, long paramLong1, long paramLong2, long[] paramArrayOflong2, int paramInt) {
    ...
    long l1 = 0L, l2 = paramArrayOflong1[i & 0x7];
    byte b = 48;
    do {
      i = (int)(paramLong1 >>> b);
