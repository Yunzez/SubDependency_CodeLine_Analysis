...
public class SecP160R2Point extends ECPoint.AbstractFp {
  ...
  protected ECPoint detach() {
    return new org.bouncycastle.math.ec.custom.sec.SecP160R2Point(null, getAffineXCoord(), getAffineYCoord());
  }
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    return new org.bouncycastle.math.ec.custom.sec.SecP160R2Point(eCCurve, secP160R2FieldElement7, secP160R2FieldElement8, arrayOfECFieldElement);
  }
  ...
  public ECPoint twice() {
    ...
    return new org.bouncycastle.math.ec.custom.sec.SecP160R2Point(eCCurve, secP160R2FieldElement4, secP160R2FieldElement5, new ECFieldElement[] { secP160R2FieldElement6 });
  }
  ...
  public ECPoint negate() {
    if (isInfinity())
      return this; 
    return new org.bouncycastle.math.ec.custom.sec.SecP160R2Point(this.curve, this.x, this.y.negate(), this.zs);
  }
}
