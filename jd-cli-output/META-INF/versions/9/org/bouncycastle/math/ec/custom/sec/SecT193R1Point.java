...
public class SecT193R1Point extends ECPoint.AbstractF2m {
  ...
  protected ECPoint detach() {
    return new org.bouncycastle.math.ec.custom.sec.SecT193R1Point(null, getAffineXCoord(), getAffineYCoord());
  }
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    if (eCFieldElement2.isZero()) {
      ...
      if (eCFieldElement13.isZero())
        return new org.bouncycastle.math.ec.custom.sec.SecT193R1Point(eCCurve, eCFieldElement13, eCCurve.getB().sqrt()); 
    ...
    return new org.bouncycastle.math.ec.custom.sec.SecT193R1Point(eCCurve, eCFieldElement13, eCFieldElement14, new ECFieldElement[] { eCFieldElement15 });
  }
  ...
  public ECPoint twice() {
    ...
    if (eCFieldElement8.isZero())
      return new org.bouncycastle.math.ec.custom.sec.SecT193R1Point(eCCurve, eCFieldElement8, eCCurve.getB().sqrt()); 
    ...
    return new org.bouncycastle.math.ec.custom.sec.SecT193R1Point(eCCurve, eCFieldElement9, eCFieldElement12, new ECFieldElement[] { eCFieldElement10 });
  }
  ...
  public ECPoint twicePlus(ECPoint paramECPoint) {
    ...
    return new org.bouncycastle.math.ec.custom.sec.SecT193R1Point(eCCurve, eCFieldElement16, eCFieldElement18, new ECFieldElement[] { eCFieldElement17 });
  }
  ...
  public ECPoint negate() {
    ...
    if (eCFieldElement1.isZero())
      return this; 
    ECFieldElement eCFieldElement2 = this.y, eCFieldElement3 = this.zs[0];
    return new org.bouncycastle.math.ec.custom.sec.SecT193R1Point(this.curve, eCFieldElement1, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[] { eCFieldElement3 });
  }
}
