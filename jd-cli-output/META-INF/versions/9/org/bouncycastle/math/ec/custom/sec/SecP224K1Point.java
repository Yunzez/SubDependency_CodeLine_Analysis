...
public class SecP224K1Point extends ECPoint.AbstractFp {
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    SecP224K1FieldElement secP224K1FieldElement1 = (SecP224K1FieldElement)this.x, secP224K1FieldElement2 = (SecP224K1FieldElement)this.y;
    SecP224K1FieldElement secP224K1FieldElement3 = (SecP224K1FieldElement)paramECPoint.getXCoord(), secP224K1FieldElement4 = (SecP224K1FieldElement)paramECPoint.getYCoord();
    ...
    return new org.bouncycastle.math.ec.custom.sec.SecP224K1Point(eCCurve, secP224K1FieldElement7, secP224K1FieldElement8, arrayOfECFieldElement);
  }
  ...
  public ECPoint twice() {
    ...
    if (secP224K1FieldElement1.isZero())
      return eCCurve.getInfinity(); 
    SecP224K1FieldElement secP224K1FieldElement2 = (SecP224K1FieldElement)this.x, secP224K1FieldElement3 = (SecP224K1FieldElement)this.zs[0];
    ...
    return new org.bouncycastle.math.ec.custom.sec.SecP224K1Point(eCCurve, secP224K1FieldElement4, secP224K1FieldElement5, new ECFieldElement[] { secP224K1FieldElement6 });
  }
  ...
  public ECPoint negate() {
    if (isInfinity())
      return this; 
    return new org.bouncycastle.math.ec.custom.sec.SecP224K1Point(this.curve, this.x, this.y.negate(), this.zs);
  }
}
