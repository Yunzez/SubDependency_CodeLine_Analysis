...
class Tnaf {
  ...
  public static BigInteger norm(byte paramByte, ZTauElement paramZTauElement) {
    BigInteger bigInteger1, bigInteger2 = paramZTauElement.u.multiply(paramZTauElement.u);
  ...
  public static SimpleBigDecimal norm(byte paramByte, SimpleBigDecimal paramSimpleBigDecimal1, SimpleBigDecimal paramSimpleBigDecimal2) {
    SimpleBigDecimal simpleBigDecimal1, simpleBigDecimal2 = paramSimpleBigDecimal1.multiply(paramSimpleBigDecimal1);
  ...
  public static byte[] tauAdicNaf(byte paramByte, ZTauElement paramZTauElement) {
    ...
    byte[] arrayOfByte1 = new byte[bool];
    byte b1 = 0;
    byte b2 = 0;
    ...
    while (!bigInteger2.equals(ECConstants.ZERO) || !bigInteger3.equals(ECConstants.ZERO)) {
      if (bigInteger2.testBit(0)) {
        arrayOfByte1[b1] = (byte)ECConstants.TWO.subtract(bigInteger2.subtract(bigInteger3.shiftLeft(1)).mod(ECConstants.FOUR)).intValue();
        if (arrayOfByte1[b1] == 1) {
  ...
  public static ZTauElement partModReduction(BigInteger paramBigInteger, int paramInt, byte paramByte1, BigInteger[] paramArrayOfBigInteger, byte paramByte2, byte paramByte3) {
    ...
    BigInteger bigInteger3 = paramBigInteger.subtract(bigInteger1.multiply(zTauElement.u)).subtract(
        BigInteger.valueOf(2L).multiply(paramArrayOfBigInteger[1]).multiply(zTauElement.v));
