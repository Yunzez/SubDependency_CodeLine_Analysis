...
public class SecT239Field {
  ...
  public static void reduce17(long[] paramArrayOflong, int paramInt) {
    long l1 = paramArrayOflong[paramInt + 3], l2 = l1 >>> 47L;
  ...
  public static void sqrt(long[] paramArrayOflong1, long[] paramArrayOflong2) {
    ...
    for (byte b = 0; b < arrayOfInt.length; b++) {
      int i = arrayOfInt[b] >>> 6, j = arrayOfInt[b] & 0x3F;
  ...
  protected static void implCompactExt(long[] paramArrayOflong) {
    long l1 = paramArrayOflong[0], l2 = paramArrayOflong[1], l3 = paramArrayOflong[2], l4 = paramArrayOflong[3], l5 = paramArrayOflong[4], l6 = paramArrayOflong[5], l7 = paramArrayOflong[6], l8 = paramArrayOflong[7];
  ...
  protected static void implMultiply(long[] paramArrayOflong1, long[] paramArrayOflong2, long[] paramArrayOflong3) {
    long[] arrayOfLong1 = new long[4], arrayOfLong2 = new long[4];
    ...
    long l1 = arrayOfLong1[0] ^ arrayOfLong1[2], l2 = arrayOfLong1[1] ^ arrayOfLong1[3];
    long l3 = arrayOfLong2[0] ^ arrayOfLong2[2], l4 = arrayOfLong2[1] ^ arrayOfLong2[3];
    ...
    long l5 = arrayOfLong4[0], l6 = arrayOfLong4[1], l7 = arrayOfLong4[2];
