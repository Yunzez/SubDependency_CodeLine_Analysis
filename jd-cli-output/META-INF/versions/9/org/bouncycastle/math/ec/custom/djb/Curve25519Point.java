...
public class Curve25519Point extends ECPoint.AbstractFp {
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    Curve25519FieldElement curve25519FieldElement1 = (Curve25519FieldElement)this.x, curve25519FieldElement2 = (Curve25519FieldElement)this.y;
    Curve25519FieldElement curve25519FieldElement3 = (Curve25519FieldElement)this.zs[0];
    Curve25519FieldElement curve25519FieldElement4 = (Curve25519FieldElement)paramECPoint.getXCoord(), curve25519FieldElement5 = (Curve25519FieldElement)paramECPoint.getYCoord();
    ...
    return new org.bouncycastle.math.ec.custom.djb.Curve25519Point(eCCurve, curve25519FieldElement7, curve25519FieldElement8, arrayOfECFieldElement);
  }
  ...
  public ECPoint negate() {
    if (isInfinity())
      return this; 
    return new org.bouncycastle.math.ec.custom.djb.Curve25519Point(getCurve(), this.x, this.y.negate(), this.zs);
  }
  ...
  protected org.bouncycastle.math.ec.custom.djb.Curve25519Point twiceJacobianModified(boolean paramBoolean) {
    Curve25519FieldElement curve25519FieldElement1 = (Curve25519FieldElement)this.x, curve25519FieldElement2 = (Curve25519FieldElement)this.y;
    Curve25519FieldElement curve25519FieldElement3 = (Curve25519FieldElement)this.zs[0], curve25519FieldElement4 = getJacobianModifiedW();
    ...
    return new org.bouncycastle.math.ec.custom.djb.Curve25519Point(getCurve(), curve25519FieldElement5, curve25519FieldElement6, new ECFieldElement[] { curve25519FieldElement7, curve25519FieldElement8 });
  }
}
