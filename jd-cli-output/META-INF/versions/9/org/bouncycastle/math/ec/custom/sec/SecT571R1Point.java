...
public class SecT571R1Point extends ECPoint.AbstractF2m {
  ...
  public ECFieldElement getYCoord() {
    ECFieldElement eCFieldElement1 = this.x, eCFieldElement2 = this.y;
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    SecT571FieldElement secT571FieldElement3 = (SecT571FieldElement)this.y, secT571FieldElement4 = (SecT571FieldElement)this.zs[0];
    SecT571FieldElement secT571FieldElement5 = (SecT571FieldElement)paramECPoint.getRawYCoord(), secT571FieldElement6 = (SecT571FieldElement)paramECPoint.getZCoord(0);
    ...
    if (secT571FieldElement2.isZero()) {
      ...
      if (secT571FieldElement7.isZero())
        return new org.bouncycastle.math.ec.custom.sec.SecT571R1Point(eCCurve, secT571FieldElement7, SecT571R1Curve.SecT571R1_B_SQRT); 
    ...
    return new org.bouncycastle.math.ec.custom.sec.SecT571R1Point(eCCurve, secT571FieldElement7, secT571FieldElement8, new ECFieldElement[] { secT571FieldElement9 });
  }
  ...
  public ECPoint twice() {
    ...
    if (secT571FieldElement1.isZero())
      return eCCurve.getInfinity(); 
    SecT571FieldElement secT571FieldElement2 = (SecT571FieldElement)this.y, secT571FieldElement3 = (SecT571FieldElement)this.zs[0];
    long[] arrayOfLong1 = Nat576.create64();
    long[] arrayOfLong2 = Nat576.create64();
    ...
    if (Nat576.isZero64(arrayOfLong6))
      return new org.bouncycastle.math.ec.custom.sec.SecT571R1Point(eCCurve, new SecT571FieldElement(arrayOfLong6), SecT571R1Curve.SecT571R1_B_SQRT); 
    ...
    return new org.bouncycastle.math.ec.custom.sec.SecT571R1Point(eCCurve, secT571FieldElement4, secT571FieldElement6, new ECFieldElement[] { secT571FieldElement5 });
  }
  ...
  public ECPoint twicePlus(ECPoint paramECPoint) {
    ...
    if (secT571FieldElement1.isZero())
      return paramECPoint; 
    SecT571FieldElement secT571FieldElement2 = (SecT571FieldElement)paramECPoint.getRawXCoord(), secT571FieldElement3 = (SecT571FieldElement)paramECPoint.getZCoord(0);
    if (secT571FieldElement2.isZero() || !secT571FieldElement3.isOne())
      return twice().add(paramECPoint); 
    SecT571FieldElement secT571FieldElement4 = (SecT571FieldElement)this.y, secT571FieldElement5 = (SecT571FieldElement)this.zs[0];
    ...
    if (Nat576.isZero64(arrayOfLong11))
      return new org.bouncycastle.math.ec.custom.sec.SecT571R1Point(eCCurve, new SecT571FieldElement(arrayOfLong11), SecT571R1Curve.SecT571R1_B_SQRT); 
    ...
    return new org.bouncycastle.math.ec.custom.sec.SecT571R1Point(eCCurve, secT571FieldElement7, secT571FieldElement9, new ECFieldElement[] { secT571FieldElement8 });
  }
  ...
  public ECPoint negate() {
    ...
    if (eCFieldElement1.isZero())
      return this; 
    ECFieldElement eCFieldElement2 = this.y, eCFieldElement3 = this.zs[0];
    return new org.bouncycastle.math.ec.custom.sec.SecT571R1Point(this.curve, eCFieldElement1, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[] { eCFieldElement3 });
  }
}
