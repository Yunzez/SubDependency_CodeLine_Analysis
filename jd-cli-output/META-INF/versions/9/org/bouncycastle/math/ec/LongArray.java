...
class LongArray implements Cloneable {
  ...
  public org.bouncycastle.math.ec.LongArray modMultiplyLD(org.bouncycastle.math.ec.LongArray paramLongArray, int paramInt, int[] paramArrayOfint) {
    ...
    org.bouncycastle.math.ec.LongArray longArray1 = this, longArray2 = paramLongArray;
    if (i > j) {
  ...
  public org.bouncycastle.math.ec.LongArray modMultiplyAlt(org.bouncycastle.math.ec.LongArray paramLongArray, int paramInt, int[] paramArrayOfint) {
    ...
    byte b1 = 4, b2 = 16, b3 = 64, b4 = 8;
    byte b5 = (b3 < 64) ? b2 : (b2 - 1);
    int i1 = j + b5 + 63 >>> 6;
    int i2 = i1 * b4, i3 = b1 * b4;
    ...
    while (true) {
      byte b = 0;
      do {
        long l = arrayOfLong[b] >>> i6;
        byte b7 = 0;
        int i8 = k;
        while (true) {
          int i9 = (int)l & i5;
          if (i9 != 0)
            add(arrayOfLong, b + arrayOfInt[i9], arrayOfLong, i8, i1); 
          if (++b7 == b4)
            break; 
          i8 += i1;
          l >>>= b1;
  ...
  private static int reduceInPlace(long[] paramArrayOflong, int paramInt1, int paramInt2, int paramInt3, int[] paramArrayOfint) {
    ...
    int m = paramArrayOfint.length, n = paramArrayOfint[m - 1];
  ...
  private static long interleave3(long paramLong) {
    ...
    return l | 
      interleave3_21to63((int)paramLong & 0x1FFFFF) | 
      interleave3_21to63((int)(paramLong >>> 21L) & 0x1FFFFF) << 1L | 
      interleave3_21to63((int)(paramLong >>> 42L) & 0x1FFFFF) << 2L;
  }
  ...
  private static long interleave5(long paramLong) {
    return interleave3_13to65((int)paramLong & 0x1FFF) | 
      interleave3_13to65((int)(paramLong >>> 13L) & 0x1FFF) << 1L | 
      interleave3_13to65((int)(paramLong >>> 26L) & 0x1FFF) << 2L | 
      interleave3_13to65((int)(paramLong >>> 39L) & 0x1FFF) << 3L | 
      interleave3_13to65((int)(paramLong >>> 52L) & 0x1FFF) << 4L;
  }
