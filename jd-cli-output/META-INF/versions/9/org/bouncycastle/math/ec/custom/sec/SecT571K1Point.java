...
public class SecT571K1Point extends ECPoint.AbstractF2m {
  ...
  public ECPoint add(ECPoint paramECPoint) {
    ...
    if (secT571FieldElement2.isZero()) {
      ...
      if (secT571FieldElement7.isZero())
        return new org.bouncycastle.math.ec.custom.sec.SecT571K1Point(eCCurve, secT571FieldElement7, eCCurve.getB()); 
    ...
    return new org.bouncycastle.math.ec.custom.sec.SecT571K1Point(eCCurve, secT571FieldElement7, secT571FieldElement8, new ECFieldElement[] { secT571FieldElement9 });
  }
  ...
  public ECPoint twice() {
    ...
    if (eCFieldElement5.isZero())
      return new org.bouncycastle.math.ec.custom.sec.SecT571K1Point(eCCurve, eCFieldElement5, eCCurve.getB()); 
    ...
    return new org.bouncycastle.math.ec.custom.sec.SecT571K1Point(eCCurve, eCFieldElement6, eCFieldElement10, new ECFieldElement[] { eCFieldElement7 });
  }
  ...
  public ECPoint twicePlus(ECPoint paramECPoint) {
    ...
    if (eCFieldElement13.isZero())
      return new org.bouncycastle.math.ec.custom.sec.SecT571K1Point(eCCurve, eCFieldElement13, eCCurve.getB()); 
    ...
    return new org.bouncycastle.math.ec.custom.sec.SecT571K1Point(eCCurve, eCFieldElement16, eCFieldElement18, new ECFieldElement[] { eCFieldElement17 });
  }
  ...
  public ECPoint negate() {
    ...
    if (eCFieldElement1.isZero())
      return this; 
    ECFieldElement eCFieldElement2 = this.y, eCFieldElement3 = this.zs[0];
    return new org.bouncycastle.math.ec.custom.sec.SecT571K1Point(this.curve, eCFieldElement1, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[] { eCFieldElement3 });
  }
}
