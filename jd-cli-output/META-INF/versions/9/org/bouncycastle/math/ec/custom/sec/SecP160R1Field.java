...
public class SecP160R1Field {
  ...
  public static void addExt(int[] paramArrayOfint1, int[] paramArrayOfint2, int[] paramArrayOfint3) {
    ...
    if (i != 0 || (paramArrayOfint3[9] == -1 && Nat.gte(10, paramArrayOfint3, PExt)))
  ...
  public static void reduce(int[] paramArrayOfint1, int[] paramArrayOfint2) {
    long l1 = paramArrayOfint1[5] & 0xFFFFFFFFL, l2 = paramArrayOfint1[6] & 0xFFFFFFFFL, l3 = paramArrayOfint1[7] & 0xFFFFFFFFL, l4 = paramArrayOfint1[8] & 0xFFFFFFFFL, l5 = paramArrayOfint1[9] & 0xFFFFFFFFL;
    long l6 = 0L;
  ...
  public static void reduce32(int paramInt, int[] paramArrayOfint) {
    if ((paramInt != 0 && Nat160.mulWordsAdd(-2147483647, paramInt, paramArrayOfint, 0) != 0) || (paramArrayOfint[4] == -1 && 
      Nat160.gte(paramArrayOfint, P)))
